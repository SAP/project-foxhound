...
class MOZ_STACK_CLASS JSONPerHandlerParser {
 ...
 public:
  JSONPerHandlerParser(ContextT* context, mozilla::Range<const CharT> data, const StringTaint& taint)
      : handler(context), tokenizer(data, taint, this), stack(context) {}
