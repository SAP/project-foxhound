...
// ./test/core/threads/LB_atomic.wast:4
register($0, `mem`);

// ./test/core/threads/LB_atomic.wast:6
let $T1 = new Thread($Mem, "$Mem", `

// ./test/core/threads/LB_atomic.wast:7:3
register(\$Mem, \`mem\`);

// ./test/core/threads/LB_atomic.wast:8:3
...
// ./test/core/threads/LB_atomic.wast:20:3
invoke(\$1, \`run\`, []);
`);

// ./test/core/threads/LB_atomic.wast:23
let $T2 = new Thread($Mem, "$Mem", `

// ./test/core/threads/LB_atomic.wast:24:3
register(\$Mem, \`mem\`);

// ./test/core/threads/LB_atomic.wast:25:3
...
// ./test/core/threads/LB_atomic.wast:38:3
invoke(\$2, \`run\`, []);
`);
...
// ./test/core/threads/LB_atomic.wast:42
$T2.wait();

// ./test/core/threads/LB_atomic.wast:44
...
// ./test/core/threads/LB_atomic.wast:65
