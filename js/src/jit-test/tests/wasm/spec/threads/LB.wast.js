...
// ./test/core/threads/LB.wast:4
register($0, `mem`);

// ./test/core/threads/LB.wast:6
let $T1 = new Thread($Mem, "$Mem", `

// ./test/core/threads/LB.wast:7:3
register(\$Mem, \`mem\`);

// ./test/core/threads/LB.wast:8:3
...
// ./test/core/threads/LB.wast:20:3
invoke(\$1, \`run\`, []);
`);

// ./test/core/threads/LB.wast:23
let $T2 = new Thread($Mem, "$Mem", `

// ./test/core/threads/LB.wast:24:3
register(\$Mem, \`mem\`);

// ./test/core/threads/LB.wast:25:3
...
// ./test/core/threads/LB.wast:38:3
invoke(\$2, \`run\`, []);
`);
...
// ./test/core/threads/LB.wast:42
$T2.wait();

// ./test/core/threads/LB.wast:44
