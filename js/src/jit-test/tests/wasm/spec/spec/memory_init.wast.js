...
// ./test/core/bulk-memory/memory_init.wast

// ./test/core/bulk-memory/memory_init.wast:6
...
// ./test/core/bulk-memory/memory_init.wast:105
invoke($2, `test`, []);

// ./test/core/bulk-memory/memory_init.wast:107
assert_return(() => invoke($2, `load8_u`, [0]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:108
assert_return(() => invoke($2, `load8_u`, [1]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:109
assert_return(() => invoke($2, `load8_u`, [2]), [value("i32", 3)]);

// ./test/core/bulk-memory/memory_init.wast:110
assert_return(() => invoke($2, `load8_u`, [3]), [value("i32", 1)]);

// ./test/core/bulk-memory/memory_init.wast:111
assert_return(() => invoke($2, `load8_u`, [4]), [value("i32", 4)]);

// ./test/core/bulk-memory/memory_init.wast:112
assert_return(() => invoke($2, `load8_u`, [5]), [value("i32", 1)]);

// ./test/core/bulk-memory/memory_init.wast:113
assert_return(() => invoke($2, `load8_u`, [6]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:114
assert_return(() => invoke($2, `load8_u`, [7]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:115
assert_return(() => invoke($2, `load8_u`, [8]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:116
assert_return(() => invoke($2, `load8_u`, [9]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:117
assert_return(() => invoke($2, `load8_u`, [10]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:118
assert_return(() => invoke($2, `load8_u`, [11]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:119
assert_return(() => invoke($2, `load8_u`, [12]), [value("i32", 7)]);

// ./test/core/bulk-memory/memory_init.wast:120
assert_return(() => invoke($2, `load8_u`, [13]), [value("i32", 5)]);

// ./test/core/bulk-memory/memory_init.wast:121
assert_return(() => invoke($2, `load8_u`, [14]), [value("i32", 2)]);

// ./test/core/bulk-memory/memory_init.wast:122
assert_return(() => invoke($2, `load8_u`, [15]), [value("i32", 9)]);

// ./test/core/bulk-memory/memory_init.wast:123
assert_return(() => invoke($2, `load8_u`, [16]), [value("i32", 2)]);

// ./test/core/bulk-memory/memory_init.wast:124
assert_return(() => invoke($2, `load8_u`, [17]), [value("i32", 7)]);

// ./test/core/bulk-memory/memory_init.wast:125
assert_return(() => invoke($2, `load8_u`, [18]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:126
assert_return(() => invoke($2, `load8_u`, [19]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:127
assert_return(() => invoke($2, `load8_u`, [20]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:128
assert_return(() => invoke($2, `load8_u`, [21]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:129
assert_return(() => invoke($2, `load8_u`, [22]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:130
assert_return(() => invoke($2, `load8_u`, [23]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:131
assert_return(() => invoke($2, `load8_u`, [24]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:132
assert_return(() => invoke($2, `load8_u`, [25]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:133
assert_return(() => invoke($2, `load8_u`, [26]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:134
assert_return(() => invoke($2, `load8_u`, [27]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:135
assert_return(() => invoke($2, `load8_u`, [28]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:136
assert_return(() => invoke($2, `load8_u`, [29]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:138
...
// ./test/core/bulk-memory/memory_init.wast:157
invoke($3, `test`, []);

// ./test/core/bulk-memory/memory_init.wast:159
assert_return(() => invoke($3, `load8_u`, [0]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:160
assert_return(() => invoke($3, `load8_u`, [1]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:161
assert_return(() => invoke($3, `load8_u`, [2]), [value("i32", 3)]);

// ./test/core/bulk-memory/memory_init.wast:162
assert_return(() => invoke($3, `load8_u`, [3]), [value("i32", 1)]);

// ./test/core/bulk-memory/memory_init.wast:163
assert_return(() => invoke($3, `load8_u`, [4]), [value("i32", 4)]);

// ./test/core/bulk-memory/memory_init.wast:164
assert_return(() => invoke($3, `load8_u`, [5]), [value("i32", 1)]);

// ./test/core/bulk-memory/memory_init.wast:165
assert_return(() => invoke($3, `load8_u`, [6]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:166
assert_return(() => invoke($3, `load8_u`, [7]), [value("i32", 2)]);

// ./test/core/bulk-memory/memory_init.wast:167
assert_return(() => invoke($3, `load8_u`, [8]), [value("i32", 7)]);

// ./test/core/bulk-memory/memory_init.wast:168
assert_return(() => invoke($3, `load8_u`, [9]), [value("i32", 1)]);

// ./test/core/bulk-memory/memory_init.wast:169
assert_return(() => invoke($3, `load8_u`, [10]), [value("i32", 8)]);

// ./test/core/bulk-memory/memory_init.wast:170
assert_return(() => invoke($3, `load8_u`, [11]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:171
assert_return(() => invoke($3, `load8_u`, [12]), [value("i32", 7)]);

// ./test/core/bulk-memory/memory_init.wast:172
assert_return(() => invoke($3, `load8_u`, [13]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:173
assert_return(() => invoke($3, `load8_u`, [14]), [value("i32", 7)]);

// ./test/core/bulk-memory/memory_init.wast:174
assert_return(() => invoke($3, `load8_u`, [15]), [value("i32", 5)]);

// ./test/core/bulk-memory/memory_init.wast:175
assert_return(() => invoke($3, `load8_u`, [16]), [value("i32", 2)]);

// ./test/core/bulk-memory/memory_init.wast:176
assert_return(() => invoke($3, `load8_u`, [17]), [value("i32", 7)]);

// ./test/core/bulk-memory/memory_init.wast:177
assert_return(() => invoke($3, `load8_u`, [18]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:178
assert_return(() => invoke($3, `load8_u`, [19]), [value("i32", 9)]);

// ./test/core/bulk-memory/memory_init.wast:179
assert_return(() => invoke($3, `load8_u`, [20]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:180
assert_return(() => invoke($3, `load8_u`, [21]), [value("i32", 7)]);

// ./test/core/bulk-memory/memory_init.wast:181
assert_return(() => invoke($3, `load8_u`, [22]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:182
assert_return(() => invoke($3, `load8_u`, [23]), [value("i32", 8)]);

// ./test/core/bulk-memory/memory_init.wast:183
assert_return(() => invoke($3, `load8_u`, [24]), [value("i32", 8)]);

// ./test/core/bulk-memory/memory_init.wast:184
assert_return(() => invoke($3, `load8_u`, [25]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:185
assert_return(() => invoke($3, `load8_u`, [26]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:186
assert_return(() => invoke($3, `load8_u`, [27]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:187
assert_return(() => invoke($3, `load8_u`, [28]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:188
assert_return(() => invoke($3, `load8_u`, [29]), [value("i32", 0)]);

// ./test/core/bulk-memory/memory_init.wast:189
assert_invalid(
  () => instantiate(`(module
     (func (export "test")
       (data.drop 0)))`),
...
// ./test/core/bulk-memory/memory_init.wast:195
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:203
...
// ./test/core/bulk-memory/memory_init.wast:209
invoke($4, `test`, []);

// ./test/core/bulk-memory/memory_init.wast:211
...
// ./test/core/bulk-memory/memory_init.wast:217
assert_trap(() => invoke($5, `test`, []), `out of bounds memory access`);

// ./test/core/bulk-memory/memory_init.wast:219
...
// ./test/core/bulk-memory/memory_init.wast:224
assert_trap(() => invoke($6, `test`, []), `out of bounds memory access`);

// ./test/core/bulk-memory/memory_init.wast:226
assert_invalid(
  () => instantiate(`(module
    (func (export "test")
...
// ./test/core/bulk-memory/memory_init.wast:232
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:240
...
// ./test/core/bulk-memory/memory_init.wast:246
invoke($7, `test`, []);

// ./test/core/bulk-memory/memory_init.wast:248
...
// ./test/core/bulk-memory/memory_init.wast:253
assert_trap(() => invoke($8, `test`, []), `out of bounds memory access`);

// ./test/core/bulk-memory/memory_init.wast:255
...
// ./test/core/bulk-memory/memory_init.wast:260
assert_trap(() => invoke($9, `test`, []), `out of bounds memory access`);

// ./test/core/bulk-memory/memory_init.wast:262
...
// ./test/core/bulk-memory/memory_init.wast:267
assert_trap(() => invoke($10, `test`, []), `out of bounds memory access`);

// ./test/core/bulk-memory/memory_init.wast:269
...
// ./test/core/bulk-memory/memory_init.wast:274
assert_trap(() => invoke($11, `test`, []), `out of bounds memory access`);

// ./test/core/bulk-memory/memory_init.wast:276
...
// ./test/core/bulk-memory/memory_init.wast:281
invoke($12, `test`, []);

// ./test/core/bulk-memory/memory_init.wast:283
...
// ./test/core/bulk-memory/memory_init.wast:288
assert_trap(() => invoke($13, `test`, []), `out of bounds memory access`);

// ./test/core/bulk-memory/memory_init.wast:290
...
// ./test/core/bulk-memory/memory_init.wast:295
invoke($14, `test`, []);

// ./test/core/bulk-memory/memory_init.wast:297
...
// ./test/core/bulk-memory/memory_init.wast:302
invoke($15, `test`, []);

// ./test/core/bulk-memory/memory_init.wast:304
...
// ./test/core/bulk-memory/memory_init.wast:309
assert_trap(() => invoke($16, `test`, []), `out of bounds memory access`);

// ./test/core/bulk-memory/memory_init.wast:311
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:319
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:327
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:335
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:343
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:351
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:359
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:367
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:375
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:383
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:391
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:399
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:407
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:415
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:423
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:431
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:439
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:447
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:455
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:463
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:471
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:479
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:487
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:495
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:503
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:511
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:519
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:527
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:535
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:543
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:551
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:559
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:567
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:575
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:583
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:591
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:599
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:607
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:615
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:623
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:631
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:639
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:647
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:655
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:663
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:671
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:679
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:687
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:695
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:703
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:711
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:719
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:727
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:735
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:743
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:751
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:759
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:767
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:775
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:783
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:791
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:799
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:807
assert_invalid(
  () => instantiate(`(module
    (memory 1)
    (data "\\37")
...
// ./test/core/bulk-memory/memory_init.wast:815
...
// ./test/core/bulk-memory/memory_init.wast:833
assert_trap(() => invoke($17, `run`, [65528, 16]), `out of bounds memory access`);

// ./test/core/bulk-memory/memory_init.wast:836
assert_return(() => invoke($17, `checkRange`, [0, 1, 0]), [value("i32", -1)]);

// ./test/core/bulk-memory/memory_init.wast:838
...
// ./test/core/bulk-memory/memory_init.wast:856
assert_trap(() => invoke($18, `run`, [65527, 16]), `out of bounds memory access`);

// ./test/core/bulk-memory/memory_init.wast:859
assert_return(() => invoke($18, `checkRange`, [0, 1, 0]), [value("i32", -1)]);

// ./test/core/bulk-memory/memory_init.wast:861
...
// ./test/core/bulk-memory/memory_init.wast:879
assert_trap(() => invoke($19, `run`, [65472, 30]), `out of bounds memory access`);

// ./test/core/bulk-memory/memory_init.wast:882
assert_return(() => invoke($19, `checkRange`, [0, 1, 0]), [value("i32", -1)]);

// ./test/core/bulk-memory/memory_init.wast:884
...
// ./test/core/bulk-memory/memory_init.wast:902
assert_trap(() => invoke($20, `run`, [65473, 31]), `out of bounds memory access`);

// ./test/core/bulk-memory/memory_init.wast:905
assert_return(() => invoke($20, `checkRange`, [0, 1, 0]), [value("i32", -1)]);

// ./test/core/bulk-memory/memory_init.wast:907
...
// ./test/core/bulk-memory/memory_init.wast:925
assert_trap(() => invoke($21, `run`, [65528, -256]), `out of bounds memory access`);

// ./test/core/bulk-memory/memory_init.wast:928
assert_return(() => invoke($21, `checkRange`, [0, 1, 0]), [value("i32", -1)]);

// ./test/core/bulk-memory/memory_init.wast:930
...
// ./test/core/bulk-memory/memory_init.wast:948
assert_trap(() => invoke($22, `run`, [0, -4]), `out of bounds memory access`);

// ./test/core/bulk-memory/memory_init.wast:951
assert_return(() => invoke($22, `checkRange`, [0, 1, 0]), [value("i32", -1)]);

// ./test/core/bulk-memory/memory_init.wast:954
