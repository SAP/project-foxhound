...
// ./test/core/memory64/memory_trap64.wast

// ./test/core/memory64/memory_trap64.wast:1
...
if (!partialOobWriteMayWritePartialData()) {
  // ./test/core/memory64/memory_trap64.wast:268
  assert_return(() => invoke($1, `i64.load`, [65528n]), [value("i64", 7523094288207667809n)]);

  // ./test/core/memory64/memory_trap64.wast:269
