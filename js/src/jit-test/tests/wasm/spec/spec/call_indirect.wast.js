...
// ./test/core/call_indirect.wast:994
assert_invalid(
  () => instantiate(`(module
  (type (func))
  (table 10 externref)
...
// ./test/core/call_indirect.wast:1005
assert_invalid(
  () => instantiate(`(module
    (table 0 funcref)
...
// ./test/core/call_indirect.wast:1012
assert_invalid(
  () => instantiate(`(module
    (table 0 funcref)
...
// ./test/core/call_indirect.wast:1021
assert_invalid(
  () => instantiate(`(module
    (type (func (param i32)))
    (table 1 funcref)
...
// ./test/core/call_indirect.wast:1037
assert_invalid(
