// |jit-test| skip-if: getBuildConfiguration("arm64-simulator") === true || getBuildConfiguration("mips64-simulator") === true || getBuildConfiguration("loong64-simulator") === true || getBuildConfiguration("riscv64-simulator") === true
//
