...
//regexp->func
var taintStr = taint.replace(/\w+/g, function(match, offset, total) {
	return "not " + match;
});
var taintInfo = taintStr.taint;
assertEq(taintInfo.length, 4);          // One taint range for every tainted word in the original string
