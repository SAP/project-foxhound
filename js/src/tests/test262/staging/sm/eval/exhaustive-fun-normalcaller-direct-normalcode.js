...
assert.sameValue(resultsY.global2, 42);

assert.sameValue(resultsY.inner3, 2);
assert.sameValue(resultsY.local3, 2);
assert.sameValue(resultsY.global3, 42);

assert.sameValue(resultsY.del, true);

assert.sameValue(resultsY.inner4, 42);
assert.sameValue(resultsY.local4, 42);
assert.sameValue(resultsY.global4, 42);
