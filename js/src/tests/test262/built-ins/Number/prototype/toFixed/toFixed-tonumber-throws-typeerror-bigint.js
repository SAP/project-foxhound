...
description: >
    Number.prototype.toFixed(_fractionDigits_) must throw a TypeError when _fractionDigits_ is a Bigint
info: |
...
assert.throws(TypeError, function() {
    (0).toFixed(0n)
}, "Number.prototype.toFixed must throw a TypeError if _fractionDigits_ is Bigint")
