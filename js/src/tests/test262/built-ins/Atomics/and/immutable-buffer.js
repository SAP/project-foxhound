// |reftest| shell-option(--enable-arraybuffer-immutable) skip-if(!this.hasOwnProperty('Atomics')||!ArrayBuffer.prototype.sliceToImmutable||!xulRuntime.shell) -- Atomics,immutable-arraybuffer is not enabled unconditionally, requires shell-options
...
info: |
  ...
  1. Let and be a new read-modify-write modification function...
