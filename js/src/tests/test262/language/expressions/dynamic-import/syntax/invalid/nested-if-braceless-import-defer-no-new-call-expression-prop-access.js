...
/*---
description: ImportCall is a CallExpression, it can't be preceded by the new keyword (property access) (nested if syntax)
...
if (true) new import.defer('./empty_FIXTURE.js').prop;
