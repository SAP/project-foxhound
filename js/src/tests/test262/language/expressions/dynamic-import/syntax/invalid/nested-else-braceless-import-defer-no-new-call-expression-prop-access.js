...
/*---
description: ImportCall is a CallExpression, it can't be preceded by the new keyword (property access) (nested else syntax)
...
} else new import.defer('./empty_FIXTURE.js').prop;
