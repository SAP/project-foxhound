...
/*---
description: ImportCall is a CallExpression, it can't be preceded by the new keyword (property access) (nested in async arrow function, returned)
...
(async () => await new import.defer('./empty_FIXTURE.js').prop)
