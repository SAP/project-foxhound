...
TemporalHelpers.assertPlainDateTime(
  date19200716.subtract(years1).toPlainDateTime(),
  1921, 7, "M07", 16, 12, 34, 0, 0, 0, 0, "add 1y",
  "shaka", 1921);
TemporalHelpers.assertPlainDateTime(
  date19200716.subtract(years4).toPlainDateTime(),
  1924, 7, "M07", 16, 12, 34, 0, 0, 0, 0, "add 4y",
  "shaka", 1924);

TemporalHelpers.assertPlainDateTime(
  date19200716.subtract(years1n).toPlainDateTime(),
  1919, 7, "M07", 16, 12, 34, 0, 0, 0, 0, "subtract 1y",
  "shaka", 1919);
TemporalHelpers.assertPlainDateTime(
  date19200716.subtract(years4n).toPlainDateTime(),
  1916, 7, "M07", 16, 12, 34, 0, 0, 0, 0, "subtract 4y",
  "shaka", 1916);

TemporalHelpers.assertPlainDateTime(
  date19191201.subtract(years3months6days17).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date19200716.subtract(months5).toPlainDateTime(),
  1920, 12, "M12", 16, 12, 34, 0, 0, 0, 0, "add 5mo with result in the same year",
  "shaka", 1920);
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1920, monthCode: "M08", day: 16, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(months5).toPlainDateTime(),
  1921, 1, "M01", 16, 12, 34, 0, 0, 0, 0, "add 5mo with result in the next year",
  "shaka", 1921);
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1918, monthCode: "M10", day: 1, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(months5).toPlainDateTime(),
  1919, 3, "M03", 1, 12, 34, 0, 0, 0, 0, "add 5mo with result in the next year on day 1 of month",
  "shaka", 1919);
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1920, monthCode: "M06", day: 31, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(months8).toPlainDateTime(),
  1921, 2, "M02", 31, 12, 34, 0, 0, 0, 0, "add 8mo with result in the next year on day 31 of month",
  "shaka", 1921);

TemporalHelpers.assertPlainDateTime(
  date19200716.subtract(years1months2).toPlainDateTime(),
  1921, 9, "M09", 16, 12, 34, 0, 0, 0, 0, "add 1y 2mo",
  "shaka", 1921);
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1920, monthCode: "M11", day: 30, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(years1months2).toPlainDateTime(),
  1922, 1, "M01", 30, 12, 34, 0, 0, 0, 0, "add 1y 2mo with result in the next year",
  "shaka", 1922);

TemporalHelpers.assertPlainDateTime(
  date19200716.subtract(months5n).toPlainDateTime(),
  1920, 2, "M02", 16, 12, 34, 0, 0, 0, 0, "subtract 5mo with result in the same year",
  "shaka", 1920);
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1920, monthCode: "M01", day: 16, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(months5n).toPlainDateTime(),
  1919, 8, "M08", 16, 12, 34, 0, 0, 0, 0, "subtract 5mo with result in the previous year",
  "shaka", 1919);
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1918, monthCode: "M02", day: 1, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(months5n).toPlainDateTime(),
  1917, 9, "M09", 1, 12, 34, 0, 0, 0, 0, "subtract 5mo with result in the previous year on day 1 of month",
  "shaka", 1917);
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1920, monthCode: "M02", day: 31, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(months8n).toPlainDateTime(),
  1919, 6, "M06", 31, 12, 34, 0, 0, 0, 0, "subtract 8mo with result in the previous year on day 31 of month",
  "shaka", 1919);

TemporalHelpers.assertPlainDateTime(
  date19200716.subtract(years1months2n).toPlainDateTime(),
  1919, 5, "M05", 16, 12, 34, 0, 0, 0, 0, "subtract 1y 2mo",
  "shaka", 1919);
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1920, monthCode: "M02", day: 17, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(years1months2n).toPlainDateTime(),
  1918, 12, "M12", 17, 12, 34, 0, 0, 0, 0, "subtract 1y 2mo with result in the previous year",
  "shaka", 1918);

TemporalHelpers.assertPlainDateTime(
  date19221201.subtract(months6).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "shaka", 1920);
TemporalHelpers.assertPlainDateTime(
  date19200527.subtract(weeks6).toPlainDateTime(),
  1920, 7, "M07", 7, 12, 34, 0, 0, 0, 0, "add 6w crossing months of 31 and 31 days",
  "shaka", 1920);

TemporalHelpers.assertPlainDateTime(
  date19201228.subtract(years1weeks2).toPlainDateTime(),
  1922, 1, "M01", 12, 12, 34, 0, 0, 0, 0, "add 1y 2w with result in the next year",
  "shaka", 1922);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1918, monthCode: "M10", day: 28, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(months2weeks3).toPlainDateTime(),
  1919, 1, "M01", 19, 12, 34, 0, 0, 0, 0, "add 2mo 3w with result in the next year",
  "shaka", 1919);
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1918, monthCode: "M10", day: 31, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(months2weeks3).toPlainDateTime(),
  1919, 1, "M01", 21, 12, 34, 0, 0, 0, 0, "add 2mo 3w with result in the next year",
  "shaka", 1919);

TemporalHelpers.assertPlainDateTime(
  date19200219.subtract(weeks1n).toPlainDateTime(),
  1920, 2, "M02", 12, 12, 34, 0, 0, 0, 0, "subtract 1w",
  "shaka", 1920);
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1920, monthCode: "M01", day: 8, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(weeks1n).toPlainDateTime(),
  1920, 1, "M01", 1, 12, 34, 0, 0, 0, 0, "subtract 1w with result on the first day of the year",
  "shaka", 1920);
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1920, monthCode: "M01", day: 7, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(weeks1n).toPlainDateTime(),
  1919, 12, "M12", 30, 12, 34, 0, 0, 0, 0, "subtract 1w with result on the last day of the previous year",
  "shaka", 1919);

TemporalHelpers.assertPlainDateTime(
  date19200704.subtract(weeks1n).toPlainDateTime(),
  1920, 6, "M06", 28, 12, 34, 0, 0, 0, 0, "subtract 1w with result in the previous 31-day month",
  "shaka", 1920);
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1920, monthCode: "M02", day: 3, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(weeks1n).toPlainDateTime(),
  1920, 1, "M01", 26, 12, 34, 0, 0, 0, 0, "subtract 1w with result in the previous 30-day month",
  "shaka", 1920);

TemporalHelpers.assertPlainDateTime(
  date19200604.subtract(weeks6n).toPlainDateTime(),
  1920, 4, "M04", 24, 12, 34, 0, 0, 0, 0, "subtract 6w with result in the same year",
  "shaka", 1920);
TemporalHelpers.assertPlainDateTime(
  date19200127.subtract(weeks6n).toPlainDateTime(),
  1919, 12, "M12", 15, 12, 34, 0, 0, 0, 0, "subtract 6w with result in the previous year",
  "shaka", 1919);
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1920, monthCode: "M07", day: 8, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(weeks6n).toPlainDateTime(),
  1920, 5, "M05", 28, 12, 34, 0, 0, 0, 0, "subtract 6w crossing months of 30 and 31 days",
  "shaka", 1920);
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1920, monthCode: "M03", day: 8, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(weeks6n).toPlainDateTime(),
  1920, 1, "M01", 27, 12, 34, 0, 0, 0, 0, "subtract 6w crossing months of 31 and 31 days",
  "shaka", 1920);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1921, monthCode: "M01", day: 5, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(years1weeks2n).toPlainDateTime(),
  1919, 12, "M12", 21, 12, 34, 0, 0, 0, 0, "subtract 1y 2w with result in the previous year",
  "shaka", 1919);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1918, monthCode: "M03", day: 2, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(months2weeks3n).toPlainDateTime(),
  1917, 12, "M12", 11, 12, 34, 0, 0, 0, 0, "subtract 2mo 3w with result in the previous year",
  "shaka", 1917);

TemporalHelpers.assertPlainDateTime(
  date19220101.subtract(weeks40).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date19200716.subtract(days10).toPlainDateTime(),
  1920, 7, "M07", 26, 12, 34, 0, 0, 0, 0, "add 10 days with result in the same month",
  "shaka", 1920);
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1920, monthCode: "M07", day: 26, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(days10).toPlainDateTime(),
  1920, 8, "M08", 6, 12, 34, 0, 0, 0, 0, "add 10 days with result in the next month",
  "shaka", 1920);
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1920, monthCode: "M12", day: 26, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(days10).toPlainDateTime(),
  1921, 1, "M01", 6, 12, 34, 0, 0, 0, 0, "add 10 days with result in the next year",
  "shaka", 1921);

TemporalHelpers.assertPlainDateTime(
  date19201228.subtract(weeks2days3).toPlainDateTime(),
  1921, 1, "M01", 15, 12, 34, 0, 0, 0, 0, "add 2w 3d with result in the next year",
  "shaka", 1921);

TemporalHelpers.assertPlainDateTime(
  date19200716.subtract(years1months2days4).toPlainDateTime(),
  1921, 9, "M09", 20, 12, 34, 0, 0, 0, 0, "add 1y 2mo 4d",
  "shaka", 1921);
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1920, monthCode: "M11", day: 30, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(years1months2days4).toPlainDateTime(),
  1922, 2, "M02", 3, 12, 34, 0, 0, 0, 0, "add 1y 2mo 4d with result in a month following a 30-day month",
  "shaka", 1922);
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1920, monthCode: "M05", day: 26, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(years1months2days4).toPlainDateTime(),
  1921, 7, "M07", 30, 12, 34, 0, 0, 0, 0, "add 1y 2mo 4d with result in a month following a 31-day month",
  "shaka", 1921);

TemporalHelpers.assertPlainDateTime(
  date19200716.subtract(days10n).toPlainDateTime(),
  1920, 7, "M07", 6, 12, 34, 0, 0, 0, 0, "subtract 10 days with result in the same month",
  "shaka", 1920);
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1920, monthCode: "M07", day: 6, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(days10n).toPlainDateTime(),
  1920, 6, "M06", 27, 12, 34, 0, 0, 0, 0, "subtract 10 days with result in the previous month",
  "shaka", 1920);
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1921, monthCode: "M01", day: 4, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(days10n).toPlainDateTime(),
  1920, 12, "M12", 24, 12, 34, 0, 0, 0, 0, "subtract 10 days with result in the previous year",
  "shaka", 1920);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1921, monthCode: "M01", day: 15, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(weeks2days3n).toPlainDateTime(),
  1920, 12, "M12", 28, 12, 34, 0, 0, 0, 0, "subtract 2w 3d with result in the previous year",
  "shaka", 1920);

TemporalHelpers.assertPlainDateTime(
  date19200716.subtract(years1months2days4n).toPlainDateTime(),
  1919, 5, "M05", 12, 12, 34, 0, 0, 0, 0, "subtract 1y 2mo 4d",
  "shaka", 1919);
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1921, monthCode: "M12", day: 4, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(years1months2days4n).toPlainDateTime(),
  1920, 9, "M09", 30, 12, 34, 0, 0, 0, 0, "subtract 1y 2mo 4d with result in a 30-day month",
  "shaka", 1920);
TemporalHelpers.assertPlainDateTime(
  date19200604.subtract(years1months2days4n).toPlainDateTime(),
  1919, 3, "M03", 31, 12, 34, 0, 0, 0, 0, "subtract 1y 2mo 4d with result in a 31-day month",
  "shaka", 1919);

TemporalHelpers.assertPlainDateTime(
  date19220101.subtract(days280).toPlainDateTime(),
  1922, 10, "M10", 5, 12, 34, 0, 0, 0, 0, "add 40 weeks, ending in same year",
  "shaka", 1922);
