...
description: Addition around end of month in the ethioaa calendar
...
const date74921201 = Temporal.ZonedDateTime.from({ year: 7492, monthCode: "M12", day: 1, hour: 12, minute: 34, timeZone: "UTC", calendar }, options);
const dates = [
  date74921201,
];
