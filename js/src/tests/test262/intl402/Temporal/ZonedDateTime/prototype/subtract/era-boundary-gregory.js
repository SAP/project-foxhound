...
const date1 = Temporal.ZonedDateTime.from({ era: "bce", eraYear: 2, monthCode: "M06", day: 15, hour: 12, minute: 34, timeZone: "UTC", calendar }, options);
...
const date2 = Temporal.ZonedDateTime.from({ era: "bce", eraYear: 1, monthCode: "M06", day: 15, hour: 12, minute: 34, timeZone: "UTC", calendar }, options);
TemporalHelpers.assertPlainDateTime(
...
const date3 = Temporal.ZonedDateTime.from({ era: "ce", eraYear: 1, monthCode: "M06", day: 15, hour: 12, minute: 34, timeZone: "UTC", calendar }, options);
TemporalHelpers.assertPlainDateTime(
...
const date4 = Temporal.ZonedDateTime.from({ era: "bce", eraYear: 5, monthCode: "M03", day: 1, hour: 12, minute: 34, timeZone: "UTC", calendar }, options);
TemporalHelpers.assertPlainDateTime(
...
const date5 = Temporal.ZonedDateTime.from({ era: "ce", eraYear: 2, monthCode: "M06", day: 15, hour: 12, minute: 34, timeZone: "UTC", calendar }, options);
TemporalHelpers.assertPlainDateTime(
...
TemporalHelpers.assertPlainDateTime(
  date2.subtract(duration1n).toPlainDateTime(),
  -1, 6, "M06", 15, 12, 34, 0, 0, 0, 0, "Subtracting 1 year from 1 BCE lands in 2 BCE",
  "bce", 2
);

const date6 = Temporal.ZonedDateTime.from({ era: "ce", eraYear: 5, monthCode: "M03", day: 1, hour: 12, minute: 34, timeZone: "UTC", calendar }, options);
TemporalHelpers.assertPlainDateTime(
  date6.subtract(new Temporal.Duration(10)).toPlainDateTime(),
