...
TemporalHelpers.assertPlainDateTime(
  common1230.subtract(months1).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  leap1230.subtract(months1).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  leap0130.subtract(months1n).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  common0130.subtract(months1n).toPlainDateTime(),
