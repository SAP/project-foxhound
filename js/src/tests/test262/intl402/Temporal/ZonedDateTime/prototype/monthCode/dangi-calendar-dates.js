...
for (var {year, month, monthCode, day } of leapMonthCases) {
  ...
  TemporalHelpers.assertPlainDateTime(date.toPlainDateTime(), year, month, monthCode, day, 0, 0, 0, 0, 0, 0, "constructing ZonedDateTime from month number");
  ...
  const constrained = Temporal.ZonedDateTime.from({
    year,
    month: 15,
    day: 1,
    timeZone: "UTC",
