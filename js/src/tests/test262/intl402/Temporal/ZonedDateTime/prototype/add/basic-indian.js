...
TemporalHelpers.assertPlainDateTime(
  date19191201.add(years3months6days17).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date19221201.add(months6).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date19220101.add(weeks40).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date19220101.add(days280).toPlainDateTime(),
  1922, 10, "M10", 5, 12, 34, 0, 0, 0, 0, "add 40 weeks, ending in same year",
  "shaka", 1922);
