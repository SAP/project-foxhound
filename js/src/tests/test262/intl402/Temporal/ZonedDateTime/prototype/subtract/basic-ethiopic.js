...
TemporalHelpers.assertPlainDateTime(
  date201813.subtract(months1).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date201813.subtract(months4).toPlainDateTime(),
...
const date200001 = Temporal.ZonedDateTime.from({ year: 2000, monthCode: "M01", day: 1, hour: 12, minute: 34, timeZone: "UTC", calendar }, options);
...
TemporalHelpers.assertPlainDateTime(
  date200001.subtract(weeks40).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M13", day: 5, hour: 12, minute: 34, timeZone: "UTC", calendar }, options).subtract(days10).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date200001.subtract(days280).toPlainDateTime(),
