...
TemporalHelpers.assertPlainDateTime(
  date4.subtract(duration1).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date5.subtract(new Temporal.Duration(-3)).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date6.subtract(duration1n).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date7.subtract(duration1n).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date8.subtract(duration1n).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date9.subtract(new Temporal.Duration(5)).toPlainDateTime(),
