...
description: Addition around end of month in the ethiopic calendar
...
const date20001201 = Temporal.ZonedDateTime.from({ year: 2000, monthCode: "M12", day: 1, hour: 12, minute: 34, timeZone: "UTC", calendar }, options);
const dates = [
  date20001201,
];
