...
const common1231 = Temporal.PlainDate.from({ year: 2562, monthCode: "M12", day: 31, calendar }, options);
const leap0131 = Temporal.PlainDate.from({ year: 2559, monthCode: "M01", day: 31, calendar }, options);
const leap1231 = Temporal.PlainDate.from({ year: 2559, monthCode: "M12", day: 31, calendar }, options);
...
TemporalHelpers.assertPlainDate(
  ...
  2562, 1, "M01", 31, "common-year Jan does not reject 31",
  "be", 2562);
...
TemporalHelpers.assertPlainDate(
  ...
  2559, 1, "M01", 31, "leap-year Jan does not reject 31",
  "be", 2559);
