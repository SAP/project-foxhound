...
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2021, monthCode: "M06", day: 1, calendar }, options).add(months2weeks3n),
...
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2021, monthCode: "M13", day: 5, calendar }, options).add(days10),
