...
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1362, monthCode: "M10", day: 30, calendar }, options).add(years1months2),
  1363, 12, "M12", 29, "add 1y 2mo with result in the next year constrained to Esfand 29",
  "ap", 1363);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1361, monthCode: "M10", day: 30, calendar }, options).add(years1months2),
...
TemporalHelpers.assertPlainDate(
  ...
  "ap", 1361);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1363, monthCode: "M11", day: 30, calendar }, options).add(months11n),
  1362, 12, "M12", 30, "subtract 11mo with result in the previous year constrained to Esfand 30",
  "ap", 1362);

TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1364, monthCode: "M02", day: 31, calendar }, options).add(years1months2n),
  1362, 12, "M12", 30, "add 1y 2mo with result in the previous year constrained to Esfand 30",
  "ap", 1362);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1365, monthCode: "M02", day: 31, calendar }, options).add(years1months2n),
...
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1363, monthCode: "M12", day: 28, calendar }, options).add(weeks1),
  1364, 1, "M01", 6, "add 1w in Esfand with result in Farvardin",
  "ap", 1364);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1362, monthCode: "M12", day: 28, calendar }, options).add(weeks1),
...
TemporalHelpers.assertPlainDate(
  ...
  "ap", 1363);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1362, monthCode: "M11", day: 27, calendar }, options).add(weeks6),
...
TemporalHelpers.assertPlainDate(
  ...
  "ap", 1364);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1361, monthCode: "M12", day: 28, calendar }, options).add(years1weeks2),
...
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1364, monthCode: "M02", day: 2, calendar }, options).add(weeks6n),
  1363, 12, "M12", 20, "subtract 6w with result in Esfand",
  "ap", 1363);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1363, monthCode: "M02", day: 2, calendar }, options).add(weeks6n),
...
TemporalHelpers.assertPlainDate(
  ...
  "ap", 1361);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1363, monthCode: "M12", day: 29, calendar }, options).add(years1weeks2n),
...
TemporalHelpers.assertPlainDate(
  ...
  "ap", 1362);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1362, monthCode: "M01", day: 1, calendar }, options).add(months2weeks3n),
...
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1362, monthCode: "M12", day: 25, calendar }, options).add(days10),
...
TemporalHelpers.assertPlainDate(
  ...
  "ap", 1365);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1362, monthCode: "M12", day: 26, calendar }, options).add(years1months2days4),
  1364, 2, "M02", 30, "add 1y 2mo 4d crossing leap-year Esfand",
  "ap", 1364);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1362, monthCode: "M12", day: 30, calendar }, options).add(years1months2days4),
  1364, 3, "M03", 3, "add 1y 2mo 4d with result rolling over into common-year Khordad",
  "ap", 1364);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1361, monthCode: "M10", day: 27, calendar }, options).add(years1months2days4),
...
TemporalHelpers.assertPlainDate(
  ...
  "ap", 1363);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1363, monthCode: "M01", day: 10, calendar }, options).add(days10n),
  1362, 12, "M12", 30, "subtract 10d with result on leap day",
  "ap", 1362);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1364, monthCode: "M01", day: 10, calendar }, options).add(days10n),
...
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1365, monthCode: "M01", day: 24, calendar }, options).add(years1months2days4n),
  1363, 11, "M11", 20, "subtract 1y 2mo 4d with result in common-year Bahman",
  "ap", 1363);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1364, monthCode: "M01", day: 24, calendar }, options).add(years1months2days4n),
  1362, 11, "M11", 20, "subtract 1y 2mo 4d with result in leap-year Bahman",
  "ap", 1362);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1365, monthCode: "M03", day: 1, calendar }, options).add(years1months2days4n),
  1363, 12, "M12", 26, "add 1y 2mo 4d with result rolling over into common-year Esfand",
  "ap", 1363);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1364, monthCode: "M03", day: 1, calendar }, options).add(years1months2days4n),
