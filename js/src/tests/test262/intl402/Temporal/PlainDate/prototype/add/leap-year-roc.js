...
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 110, monthCode: "M09", day: 30, calendar }, options).add(months5),
  111, 2, "M02", 28, "add 5mo with result in the next year constrained to Feb 28",
  "roc", 111);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 108, monthCode: "M09", day: 30, calendar }, options).add(months5),
  109, 2, "M02", 29, "add 5mo with result in the next year constrained to Feb 29",
  "roc", 109);

TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 110, monthCode: "M12", day: 31, calendar }, options).add(years1months2),
  112, 2, "M02", 28, "add 1y 2mo with result in the next year constrained to Feb 28",
  "roc", 112);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 111, monthCode: "M12", day: 31, calendar }, options).add(years1months2),
...
TemporalHelpers.assertPlainDate(
  ...
  "roc", 108);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 110, monthCode: "M01", day: 31, calendar }, options).add(months11n),
  109, 2, "M02", 29, "add 11mo with result in the next year constrained to Feb 29",
  "roc", 109);

TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 111, monthCode: "M04", day: 30, calendar }, options).add(years1months2n),
  110, 2, "M02", 28, "add 1y 2mo with result in the previous year constrained to Feb 28",
  "roc", 110);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 110, monthCode: "M04", day: 30, calendar }, options).add(years1months2n),
...
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 110, monthCode: "M02", day: 27, calendar }, options).add(weeks1),
  110, 3, "M03", 6, "add 1w in Feb with result in March",
  "roc", 110);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 109, monthCode: "M02", day: 27, calendar }, options).add(weeks1),
...
TemporalHelpers.assertPlainDate(
  ...
  "roc", 109);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 109, monthCode: "M01", day: 27, calendar }, options).add(weeks6),
...
TemporalHelpers.assertPlainDate(
  ...
  "roc", 110);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 108, monthCode: "M02", day: 28, calendar }, options).add(years1weeks2),
...
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 110, monthCode: "M04", day: 2, calendar }, options).add(weeks6n),
  110, 2, "M02", 19, "subtract 6w with result in Feb",
  "roc", 110);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 109, monthCode: "M04", day: 2, calendar }, options).add(weeks6n),
  109, 2, "M02", 20, "subtract 6w with result in leap-year Feb",
  "roc", 109);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 109, monthCode: "M03", day: 9, calendar }, options).add(weeks6n),
...
TemporalHelpers.assertPlainDate(
  ...
  "roc", 108);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 112, monthCode: "M03", day: 1, calendar }, options).add(years1weeks2n),
...
TemporalHelpers.assertPlainDate(
  ...
  "roc", 108);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 108, monthCode: "M03", day: 1, calendar }, options).add(months2weeks3n),
...
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 109, monthCode: "M02", day: 26, calendar }, options).add(days10),
...
TemporalHelpers.assertPlainDate(
  ...
  "roc", 111);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 112, monthCode: "M02", day: 26, calendar }, options).add(years1months2days4),
  113, 4, "M04", 30, "add 1y 2mo 4d with result in leap-year April",
  "roc", 113);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 110, monthCode: "M12", day: 30, calendar }, options).add(years1months2days4),
  112, 3, "M03", 4, "add 1y 2mo 4d with result rolling over into common-year March",
  "roc", 112);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 111, monthCode: "M12", day: 30, calendar }, options).add(years1months2days4),
  113, 3, "M03", 4, "add 1y 2mo 4d with result rolling over into leap-year March",
  "roc", 113);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 111, monthCode: "M12", day: 29, calendar }, options).add(years1months2days4),
  113, 3, "M03", 4, "add 1y 2mo 4d with result rolling over into leap-year March",
  "roc", 113);
...
TemporalHelpers.assertPlainDate(
  ...
  "roc", 110);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 109, monthCode: "M03", day: 10, calendar }, options).add(days10n),
  109, 2, "M02", 29, "subtract 10d with result on leap day",
  "roc", 109);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 110, monthCode: "M03", day: 10, calendar }, options).add(days10n),
...
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 112, monthCode: "M03", day: 24, calendar }, options).add(years1months2days4n),
  111, 1, "M01", 20, "subtract 1y 2mo 4d with result in common-year January",
  "roc", 111);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 110, monthCode: "M03", day: 24, calendar }, options).add(years1months2days4n),
  109, 1, "M01", 20, "subtract 1y 2mo 4d with result in leap-year January",
  "roc", 109);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 112, monthCode: "M05", day: 1, calendar }, options).add(years1months2days4n),
  111, 2, "M02", 25, "add 1y 2mo 4d with result rolling over into common-year February",
  "roc", 111);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 110, monthCode: "M05", day: 1, calendar }, options).add(years1months2days4n),
