...
const common1Month4 = Temporal.PlainDate.from({ year: 2000, monthCode: "M04", day: 1, calendar }, options);
const common1Month5 = Temporal.PlainDate.from({ year: 2000, monthCode: "M05", day: 1, calendar }, options);
const common1Month6 = Temporal.PlainDate.from({ year: 2000, monthCode: "M06", day: 1, calendar }, options);
const leapMonth4 = Temporal.PlainDate.from({ year: 2001, monthCode: "M04", day: 1, calendar }, options);
const leapMonth4L = Temporal.PlainDate.from({ year: 2001, monthCode: "M04L", day: 1, calendar }, options);
const leapMonth5 = Temporal.PlainDate.from({ year: 2001, monthCode: "M05", day: 1, calendar }, options);
const common2Month4 = Temporal.PlainDate.from({ year: 2002, monthCode: "M04", day: 1, calendar }, options);
const common2Month5 = Temporal.PlainDate.from({ year: 2002, monthCode: "M05", day: 1, calendar }, options);
...
const tests = [
  [
    ...
    [0, -12, 0, 0, "M04-M04 common-leap backwards is -12mo"],
  ],
  [
    leapMonth4, common2Month4,
    [-1, 0, 0, 0, "M04-M04 leap-common backwards is -1y"],
    [0, -13, 0, 0, "M04-M04 leap-common backwards is -13mo not -12mo"],
  ],
  [
  ...
  [
    ...
    [0, -12, 0, 0, "M05-M05 leap-common backwards is -12mo"],
  ],
  [
  ...
  [
    ...
    [-1, -1, 0, 0, "M04-M04L backwards is -1y -1mo"],
    [0, -13, 0, 0, "M04-M04L backwards is -13mo"],
  ],
  [
    leapMonth4L, common2Month4,
    [0, -12, 0, 0, "M04L-M04 backwards is -12mo not -1y"],
    [0, -12, 0, 0, "M04L-M04 backwards is -12mo"],
  ],
  [
    common1Month5, leapMonth4L,
    [0, -12, 0, 0, "M05-M04L backwards is -12mo not -1y"],
    [0, -12, 0, 0, "M05-M04L backwards is -12mo"],
  ],
  [
    leapMonth4L, common2Month5,
    [-1, -1, 0, 0, "M04L-M05 backwards is -1y -1mo (exhibits calendar-specific constraining)"],
    [0, -13, 0, 0, "M04L-M05 backwards is -13mo"],
  ],
  [
    common1Month6, leapMonth5,
    [0, -12, 0, 0, "M06-M05 common-leap backwards is -12mo not -11mo"],
    [0, -12, 0, 0, "M06-M05 common-leap backwards is -12mo not -11mo"],
  ],
  ...
  [
    ...
    [0, 13, 0, 0, "M04-M04 common-leap is 13mo not 12mo"],
  ],
  [
    leapMonth4, common1Month4,
    [1, 0, 0, 0, "M04-M04 leap-common is 1y"],
    [0, 12, 0, 0, "M04-M04 leap-common is 12mo not 13mo"],
  ],
  [
  ...
  [
    ...
    [0, 12, 0, 0, "M05-M05 common-leap is 12mo not 13mo"],
  ],
  [
  ...
  [
    ...
    [0, 12, 0, 0, "M04-M04L is 12mo not 1y"],
    [0, 12, 0, 0, "M04-M04L is 12mo"],
  ],
  [
    leapMonth4L, common1Month4,
    [1, 0, 0, 0, "M04L-M04 is 1y not 1y 1mo (exhibits calendar-specific constraining)"],
    [0, 13, 0, 0, "M04L-M04 is 13mo"],
  ],
  [
    common2Month5, leapMonth4L,
    [1, 1, 0, 0, "M05-M04L is 1y 1mo"],
    [0, 13, 0, 0, "M05-M04L is 13mo"],
  ],
  [
    leapMonth4L, common1Month5,
    [0, 12, 0, 0, "M04L-M05 is 12mo not 1y"],
    [0, 12, 0, 0, "M04L-M05 is 12mo"],
  ],
];
