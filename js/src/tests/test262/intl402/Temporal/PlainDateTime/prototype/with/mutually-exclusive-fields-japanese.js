...
const lastDayOfShowa = Temporal.PlainDateTime.from({ era: "showa", eraYear: 64, year: 1989, month: 1, monthCode: "M01", day: 7, hour: 12, minute: 34, calendar: "japanese" }, options);
