...
const common0131 = Temporal.PlainDateTime.from({ year: 1363, monthCode: "M01", day: 31, hour: 12, minute: 34, calendar }, options);
const leap0131 = Temporal.PlainDateTime.from({ year: 1362, monthCode: "M01", day: 31, hour: 12, minute: 34, calendar }, options);
