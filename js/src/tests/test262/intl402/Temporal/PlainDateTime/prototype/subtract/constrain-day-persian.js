...
const date13620131 = Temporal.PlainDateTime.from({ year: 1362, monthCode: "M01", day: 31, hour: 12, minute: 34, calendar }, options);
const date13630131 = Temporal.PlainDateTime.from({ year: 1363, monthCode: "M01", day: 31, hour: 12, minute: 34, calendar }, options);
const date13640131 = Temporal.PlainDateTime.from({ year: 1364, monthCode: "M01", day: 31, hour: 12, minute: 34, calendar }, options);
...
TemporalHelpers.assertPlainDateTime(
  date13630131.subtract(months2, options),
  1363, 3, "M03", 31, 12, 34, 0, 0, 0, 0, "common-year Khordad does not reject 31",
  "ap", 1363);

TemporalHelpers.assertPlainDateTime(
  date13630131.subtract(months8),
...
TemporalHelpers.assertPlainDateTime(
  date13630131.subtract(months3, options),
  1363, 4, "M04", 31, 12, 34, 0, 0, 0, 0, "common-year Tir does not reject 31",
  "ap", 1363);

TemporalHelpers.assertPlainDateTime(
  date13630131.subtract(months9),
...
TemporalHelpers.assertPlainDateTime(
  date13630131.subtract(months4, options),
  1363, 5, "M05", 31, 12, 34, 0, 0, 0, 0, "common-year Mordad does not reject 31",
  "ap", 1363);

TemporalHelpers.assertPlainDateTime(
  date13630131.subtract(months10),
...
TemporalHelpers.assertPlainDateTime(
  date13620131.subtract(months2, options),
  1362, 3, "M03", 31, 12, 34, 0, 0, 0, 0, "leap-year Khordad does not reject 31",
  "ap", 1362);

TemporalHelpers.assertPlainDateTime(
  date13620131.subtract(months8),
...
TemporalHelpers.assertPlainDateTime(
  date13620131.subtract(months3, options),
  1362, 4, "M04", 31, 12, 34, 0, 0, 0, 0, "leap-year Tir does not reject 31",
  "ap", 1362);

TemporalHelpers.assertPlainDateTime(
  date13620131.subtract(months9),
...
TemporalHelpers.assertPlainDateTime(
  date13620131.subtract(months4, options),
  1362, 5, "M05", 31, 12, 34, 0, 0, 0, 0, "leap-year Mordad does not reject 31",
  "ap", 1362);

TemporalHelpers.assertPlainDateTime(
  date13620131.subtract(months10),
...
TemporalHelpers.assertPlainDateTime(
  date13620131.subtract(months5, options),
  1362, 6, "M06", 31, 12, 34, 0, 0, 0, 0, "leap-year Shahrivar does not reject 31",
  "ap", 1362);

TemporalHelpers.assertPlainDateTime(
  date13620131.subtract(months11),
...
TemporalHelpers.assertPlainDateTime(
  date13640131.subtract(months12n, options),
  1363, 1, "M01", 31, 12, 34, 0, 0, 0, 0, "common-year Farvardin does not reject 31",
  "ap", 1363);

TemporalHelpers.assertPlainDateTime(
  date13640131.subtract(months11n, options),
  1363, 2, "M02", 31, 12, 34, 0, 0, 0, 0, "common-year Ordibehesht does not reject 31",
  "ap", 1363);

TemporalHelpers.assertPlainDateTime(
  date13640131.subtract(months10n, options),
  1363, 3, "M03", 31, 12, 34, 0, 0, 0, 0, "common-year Khordad does not reject 31",
  "ap", 1363);

TemporalHelpers.assertPlainDateTime(
  date13640131.subtract(months9n, options),
  1363, 4, "M04", 31, 12, 34, 0, 0, 0, 0, "common-year Tir does not reject 31",
  "ap", 1363);

TemporalHelpers.assertPlainDateTime(
  date13640131.subtract(months8n, options),
  1363, 5, "M05", 31, 12, 34, 0, 0, 0, 0, "common-year Mordad does not reject 31",
  "ap", 1363);

TemporalHelpers.assertPlainDateTime(
  date13640131.subtract(months7n, options),
  1363, 6, "M06", 31, 12, 34, 0, 0, 0, 0, "common-year Shahrivar does not reject 31",
  "ap", 1363);

TemporalHelpers.assertPlainDateTime(
  date13640131.subtract(months6n),
  1363, 7, "M07", 30, 12, 34, 0, 0, 0, 0, "common-year Mehr constrains to 30",
  "ap", 1363);
assert.throws(RangeError, function () {
...
TemporalHelpers.assertPlainDateTime(
  date13640131.subtract(months5n),
  1363, 8, "M08", 30, 12, 34, 0, 0, 0, 0, "common-year Aban constrains to 30",
  "ap", 1363);
assert.throws(RangeError, function () {
...
TemporalHelpers.assertPlainDateTime(
  date13640131.subtract(months4n),
  1363, 9, "M09", 30, 12, 34, 0, 0, 0, 0, "common-year Azar constrains to 30",
  "ap", 1363);
assert.throws(RangeError, function () {
...
TemporalHelpers.assertPlainDateTime(
  date13640131.subtract(months3n),
  1363, 10, "M10", 30, 12, 34, 0, 0, 0, 0, "common-year Dey constrains to 30",
  "ap", 1363);
assert.throws(RangeError, function () {
...
TemporalHelpers.assertPlainDateTime(
  date13640131.subtract(months2n),
  1363, 11, "M11", 30, 12, 34, 0, 0, 0, 0, "common-year Bahman constrains to 30",
  "ap", 1363);
assert.throws(RangeError, function () {
...
TemporalHelpers.assertPlainDateTime(
  date13640131.subtract(months1n),
  1363, 12, "M12", 29, 12, 34, 0, 0, 0, 0, "common-year Esfand constrains to 29",
  "ap", 1363);
assert.throws(RangeError, function () {
...
TemporalHelpers.assertPlainDateTime(
  date13630131.subtract(months12n, options),
  1362, 1, "M01", 31, 12, 34, 0, 0, 0, 0, "leap-year Farvardin does not reject 31",
  "ap", 1362);

TemporalHelpers.assertPlainDateTime(
  date13630131.subtract(months11n, options),
  1362, 2, "M02", 31, 12, 34, 0, 0, 0, 0, "leap-year Ordibehesht does not reject 31",
  "ap", 1362);

TemporalHelpers.assertPlainDateTime(
  date13630131.subtract(months10n, options),
  1362, 3, "M03", 31, 12, 34, 0, 0, 0, 0, "leap-year Khordad does not reject 31",
  "ap", 1362);

TemporalHelpers.assertPlainDateTime(
  date13630131.subtract(months9n, options),
  1362, 4, "M04", 31, 12, 34, 0, 0, 0, 0, "leap-year Tir does not reject 31",
  "ap", 1362);

TemporalHelpers.assertPlainDateTime(
  date13630131.subtract(months8n, options),
  1362, 5, "M05", 31, 12, 34, 0, 0, 0, 0, "leap-year Mordad does not reject 31",
  "ap", 1362);

TemporalHelpers.assertPlainDateTime(
  date13630131.subtract(months7n, options),
  1362, 6, "M06", 31, 12, 34, 0, 0, 0, 0, "leap-year Shahrivar does not reject 31",
  "ap", 1362);

TemporalHelpers.assertPlainDateTime(
  date13630131.subtract(months6n),
  1362, 7, "M07", 30, 12, 34, 0, 0, 0, 0, "leap-year Mehr constrains to 30",
  "ap", 1362);
assert.throws(RangeError, function () {
...
TemporalHelpers.assertPlainDateTime(
  date13630131.subtract(months5n),
  1362, 8, "M08", 30, 12, 34, 0, 0, 0, 0, "leap-year Aban constrains to 30",
  "ap", 1362);
assert.throws(RangeError, function () {
...
TemporalHelpers.assertPlainDateTime(
  date13630131.subtract(months4n),
...
TemporalHelpers.assertPlainDateTime(
  date13630131.subtract(months3n),
  1362, 10, "M10", 30, 12, 34, 0, 0, 0, 0, "leap-year Dey constrains to 30",
  "ap", 1362);
assert.throws(RangeError, function () {
...
TemporalHelpers.assertPlainDateTime(
  date13630131.subtract(months2n),
  1362, 11, "M11", 30, 12, 34, 0, 0, 0, 0, "leap-year Bahman constrains to 30",
  "ap", 1362);
assert.throws(RangeError, function () {
