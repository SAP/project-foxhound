...
description: Addition around end of month in the Hebrew calendar
...
const date57611201 = Temporal.PlainDateTime.from({ year: 5761, monthCode: "M12", day: 1, hour: 12, minute: 34, calendar }, options);
const dates = [
  date57611201,
];
