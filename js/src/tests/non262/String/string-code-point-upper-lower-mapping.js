...
assertEq(String.fromCodePoint(0x10D70).toUpperCase().codePointAt(0), 0x10D50); // GARAY SMALL LETTER A, GARAY CAPITAL LETTER A
assertEq(String.fromCodePoint(0x10D71).toUpperCase().codePointAt(0), 0x10D51); // GARAY SMALL LETTER CA, GARAY CAPITAL LETTER CA
assertEq(String.fromCodePoint(0x10D72).toUpperCase().codePointAt(0), 0x10D52); // GARAY SMALL LETTER MA, GARAY CAPITAL LETTER MA
assertEq(String.fromCodePoint(0x10D73).toUpperCase().codePointAt(0), 0x10D53); // GARAY SMALL LETTER KA, GARAY CAPITAL LETTER KA
assertEq(String.fromCodePoint(0x10D74).toUpperCase().codePointAt(0), 0x10D54); // GARAY SMALL LETTER BA, GARAY CAPITAL LETTER BA
assertEq(String.fromCodePoint(0x10D75).toUpperCase().codePointAt(0), 0x10D55); // GARAY SMALL LETTER JA, GARAY CAPITAL LETTER JA
assertEq(String.fromCodePoint(0x10D76).toUpperCase().codePointAt(0), 0x10D56); // GARAY SMALL LETTER SA, GARAY CAPITAL LETTER SA
assertEq(String.fromCodePoint(0x10D77).toUpperCase().codePointAt(0), 0x10D57); // GARAY SMALL LETTER WA, GARAY CAPITAL LETTER WA
assertEq(String.fromCodePoint(0x10D78).toUpperCase().codePointAt(0), 0x10D58); // GARAY SMALL LETTER LA, GARAY CAPITAL LETTER LA
assertEq(String.fromCodePoint(0x10D79).toUpperCase().codePointAt(0), 0x10D59); // GARAY SMALL LETTER GA, GARAY CAPITAL LETTER GA
assertEq(String.fromCodePoint(0x10D7A).toUpperCase().codePointAt(0), 0x10D5A); // GARAY SMALL LETTER DA, GARAY CAPITAL LETTER DA
assertEq(String.fromCodePoint(0x10D7B).toUpperCase().codePointAt(0), 0x10D5B); // GARAY SMALL LETTER XA, GARAY CAPITAL LETTER XA
assertEq(String.fromCodePoint(0x10D7C).toUpperCase().codePointAt(0), 0x10D5C); // GARAY SMALL LETTER YA, GARAY CAPITAL LETTER YA
assertEq(String.fromCodePoint(0x10D7D).toUpperCase().codePointAt(0), 0x10D5D); // GARAY SMALL LETTER TA, GARAY CAPITAL LETTER TA
assertEq(String.fromCodePoint(0x10D7E).toUpperCase().codePointAt(0), 0x10D5E); // GARAY SMALL LETTER RA, GARAY CAPITAL LETTER RA
assertEq(String.fromCodePoint(0x10D7F).toUpperCase().codePointAt(0), 0x10D5F); // GARAY SMALL LETTER NYA, GARAY CAPITAL LETTER NYA
assertEq(String.fromCodePoint(0x10D80).toUpperCase().codePointAt(0), 0x10D60); // GARAY SMALL LETTER FA, GARAY CAPITAL LETTER FA
assertEq(String.fromCodePoint(0x10D81).toUpperCase().codePointAt(0), 0x10D61); // GARAY SMALL LETTER NA, GARAY CAPITAL LETTER NA
assertEq(String.fromCodePoint(0x10D82).toUpperCase().codePointAt(0), 0x10D62); // GARAY SMALL LETTER PA, GARAY CAPITAL LETTER PA
assertEq(String.fromCodePoint(0x10D83).toUpperCase().codePointAt(0), 0x10D63); // GARAY SMALL LETTER HA, GARAY CAPITAL LETTER HA
assertEq(String.fromCodePoint(0x10D84).toUpperCase().codePointAt(0), 0x10D64); // GARAY SMALL LETTER OLD KA, GARAY CAPITAL LETTER OLD KA
assertEq(String.fromCodePoint(0x10D85).toUpperCase().codePointAt(0), 0x10D65); // GARAY SMALL LETTER OLD NA, GARAY CAPITAL LETTER OLD NA
...
assertEq(String.fromCodePoint(0x16EBB).toUpperCase().codePointAt(0), 0x16EA0); // BERIA ERFE SMALL LETTER ARKAB, BERIA ERFE CAPITAL LETTER ARKAB
assertEq(String.fromCodePoint(0x16EBC).toUpperCase().codePointAt(0), 0x16EA1); // BERIA ERFE SMALL LETTER BASIGNA, BERIA ERFE CAPITAL LETTER BASIGNA
assertEq(String.fromCodePoint(0x16EBD).toUpperCase().codePointAt(0), 0x16EA2); // BERIA ERFE SMALL LETTER DARBAI, BERIA ERFE CAPITAL LETTER DARBAI
assertEq(String.fromCodePoint(0x16EBE).toUpperCase().codePointAt(0), 0x16EA3); // BERIA ERFE SMALL LETTER EH, BERIA ERFE CAPITAL LETTER EH
assertEq(String.fromCodePoint(0x16EBF).toUpperCase().codePointAt(0), 0x16EA4); // BERIA ERFE SMALL LETTER FITKO, BERIA ERFE CAPITAL LETTER FITKO
assertEq(String.fromCodePoint(0x16EC0).toUpperCase().codePointAt(0), 0x16EA5); // BERIA ERFE SMALL LETTER GOWAY, BERIA ERFE CAPITAL LETTER GOWAY
assertEq(String.fromCodePoint(0x16EC1).toUpperCase().codePointAt(0), 0x16EA6); // BERIA ERFE SMALL LETTER HIRDEABO, BERIA ERFE CAPITAL LETTER HIRDEABO
assertEq(String.fromCodePoint(0x16EC2).toUpperCase().codePointAt(0), 0x16EA7); // BERIA ERFE SMALL LETTER I, BERIA ERFE CAPITAL LETTER I
assertEq(String.fromCodePoint(0x16EC3).toUpperCase().codePointAt(0), 0x16EA8); // BERIA ERFE SMALL LETTER DJAI, BERIA ERFE CAPITAL LETTER DJAI
assertEq(String.fromCodePoint(0x16EC4).toUpperCase().codePointAt(0), 0x16EA9); // BERIA ERFE SMALL LETTER KOBO, BERIA ERFE CAPITAL LETTER KOBO
assertEq(String.fromCodePoint(0x16EC5).toUpperCase().codePointAt(0), 0x16EAA); // BERIA ERFE SMALL LETTER LAKKO, BERIA ERFE CAPITAL LETTER LAKKO
assertEq(String.fromCodePoint(0x16EC6).toUpperCase().codePointAt(0), 0x16EAB); // BERIA ERFE SMALL LETTER MERI, BERIA ERFE CAPITAL LETTER MERI
assertEq(String.fromCodePoint(0x16EC7).toUpperCase().codePointAt(0), 0x16EAC); // BERIA ERFE SMALL LETTER NINI, BERIA ERFE CAPITAL LETTER NINI
assertEq(String.fromCodePoint(0x16EC8).toUpperCase().codePointAt(0), 0x16EAD); // BERIA ERFE SMALL LETTER GNA, BERIA ERFE CAPITAL LETTER GNA
assertEq(String.fromCodePoint(0x16EC9).toUpperCase().codePointAt(0), 0x16EAE); // BERIA ERFE SMALL LETTER NGAY, BERIA ERFE CAPITAL LETTER NGAY
assertEq(String.fromCodePoint(0x16ECA).toUpperCase().codePointAt(0), 0x16EAF); // BERIA ERFE SMALL LETTER OI, BERIA ERFE CAPITAL LETTER OI
assertEq(String.fromCodePoint(0x16ECB).toUpperCase().codePointAt(0), 0x16EB0); // BERIA ERFE SMALL LETTER PI, BERIA ERFE CAPITAL LETTER PI
assertEq(String.fromCodePoint(0x16ECC).toUpperCase().codePointAt(0), 0x16EB1); // BERIA ERFE SMALL LETTER ERIGO, BERIA ERFE CAPITAL LETTER ERIGO
assertEq(String.fromCodePoint(0x16ECD).toUpperCase().codePointAt(0), 0x16EB2); // BERIA ERFE SMALL LETTER ERIGO TAMURA, BERIA ERFE CAPITAL LETTER ERIGO TAMURA
assertEq(String.fromCodePoint(0x16ECE).toUpperCase().codePointAt(0), 0x16EB3); // BERIA ERFE SMALL LETTER SERI, BERIA ERFE CAPITAL LETTER SERI
assertEq(String.fromCodePoint(0x16ECF).toUpperCase().codePointAt(0), 0x16EB4); // BERIA ERFE SMALL LETTER SHEP, BERIA ERFE CAPITAL LETTER SHEP
assertEq(String.fromCodePoint(0x16ED0).toUpperCase().codePointAt(0), 0x16EB5); // BERIA ERFE SMALL LETTER TATASOUE, BERIA ERFE CAPITAL LETTER TATASOUE
assertEq(String.fromCodePoint(0x16ED1).toUpperCase().codePointAt(0), 0x16EB6); // BERIA ERFE SMALL LETTER UI, BERIA ERFE CAPITAL LETTER UI
assertEq(String.fromCodePoint(0x16ED2).toUpperCase().codePointAt(0), 0x16EB7); // BERIA ERFE SMALL LETTER WASSE, BERIA ERFE CAPITAL LETTER WASSE
assertEq(String.fromCodePoint(0x16ED3).toUpperCase().codePointAt(0), 0x16EB8); // BERIA ERFE SMALL LETTER AY, BERIA ERFE CAPITAL LETTER AY
...
assertEq(String.fromCodePoint(0x10D50).toLowerCase().codePointAt(0), 0x10D70); // GARAY CAPITAL LETTER A, GARAY SMALL LETTER A
assertEq(String.fromCodePoint(0x10D51).toLowerCase().codePointAt(0), 0x10D71); // GARAY CAPITAL LETTER CA, GARAY SMALL LETTER CA
assertEq(String.fromCodePoint(0x10D52).toLowerCase().codePointAt(0), 0x10D72); // GARAY CAPITAL LETTER MA, GARAY SMALL LETTER MA
assertEq(String.fromCodePoint(0x10D53).toLowerCase().codePointAt(0), 0x10D73); // GARAY CAPITAL LETTER KA, GARAY SMALL LETTER KA
assertEq(String.fromCodePoint(0x10D54).toLowerCase().codePointAt(0), 0x10D74); // GARAY CAPITAL LETTER BA, GARAY SMALL LETTER BA
assertEq(String.fromCodePoint(0x10D55).toLowerCase().codePointAt(0), 0x10D75); // GARAY CAPITAL LETTER JA, GARAY SMALL LETTER JA
assertEq(String.fromCodePoint(0x10D56).toLowerCase().codePointAt(0), 0x10D76); // GARAY CAPITAL LETTER SA, GARAY SMALL LETTER SA
assertEq(String.fromCodePoint(0x10D57).toLowerCase().codePointAt(0), 0x10D77); // GARAY CAPITAL LETTER WA, GARAY SMALL LETTER WA
assertEq(String.fromCodePoint(0x10D58).toLowerCase().codePointAt(0), 0x10D78); // GARAY CAPITAL LETTER LA, GARAY SMALL LETTER LA
assertEq(String.fromCodePoint(0x10D59).toLowerCase().codePointAt(0), 0x10D79); // GARAY CAPITAL LETTER GA, GARAY SMALL LETTER GA
assertEq(String.fromCodePoint(0x10D5A).toLowerCase().codePointAt(0), 0x10D7A); // GARAY CAPITAL LETTER DA, GARAY SMALL LETTER DA
assertEq(String.fromCodePoint(0x10D5B).toLowerCase().codePointAt(0), 0x10D7B); // GARAY CAPITAL LETTER XA, GARAY SMALL LETTER XA
assertEq(String.fromCodePoint(0x10D5C).toLowerCase().codePointAt(0), 0x10D7C); // GARAY CAPITAL LETTER YA, GARAY SMALL LETTER YA
assertEq(String.fromCodePoint(0x10D5D).toLowerCase().codePointAt(0), 0x10D7D); // GARAY CAPITAL LETTER TA, GARAY SMALL LETTER TA
assertEq(String.fromCodePoint(0x10D5E).toLowerCase().codePointAt(0), 0x10D7E); // GARAY CAPITAL LETTER RA, GARAY SMALL LETTER RA
assertEq(String.fromCodePoint(0x10D5F).toLowerCase().codePointAt(0), 0x10D7F); // GARAY CAPITAL LETTER NYA, GARAY SMALL LETTER NYA
assertEq(String.fromCodePoint(0x10D60).toLowerCase().codePointAt(0), 0x10D80); // GARAY CAPITAL LETTER FA, GARAY SMALL LETTER FA
assertEq(String.fromCodePoint(0x10D61).toLowerCase().codePointAt(0), 0x10D81); // GARAY CAPITAL LETTER NA, GARAY SMALL LETTER NA
assertEq(String.fromCodePoint(0x10D62).toLowerCase().codePointAt(0), 0x10D82); // GARAY CAPITAL LETTER PA, GARAY SMALL LETTER PA
assertEq(String.fromCodePoint(0x10D63).toLowerCase().codePointAt(0), 0x10D83); // GARAY CAPITAL LETTER HA, GARAY SMALL LETTER HA
assertEq(String.fromCodePoint(0x10D64).toLowerCase().codePointAt(0), 0x10D84); // GARAY CAPITAL LETTER OLD KA, GARAY SMALL LETTER OLD KA
assertEq(String.fromCodePoint(0x10D65).toLowerCase().codePointAt(0), 0x10D85); // GARAY CAPITAL LETTER OLD NA, GARAY SMALL LETTER OLD NA
...
assertEq(String.fromCodePoint(0x16EA0).toLowerCase().codePointAt(0), 0x16EBB); // BERIA ERFE CAPITAL LETTER ARKAB, BERIA ERFE SMALL LETTER ARKAB
assertEq(String.fromCodePoint(0x16EA1).toLowerCase().codePointAt(0), 0x16EBC); // BERIA ERFE CAPITAL LETTER BASIGNA, BERIA ERFE SMALL LETTER BASIGNA
assertEq(String.fromCodePoint(0x16EA2).toLowerCase().codePointAt(0), 0x16EBD); // BERIA ERFE CAPITAL LETTER DARBAI, BERIA ERFE SMALL LETTER DARBAI
assertEq(String.fromCodePoint(0x16EA3).toLowerCase().codePointAt(0), 0x16EBE); // BERIA ERFE CAPITAL LETTER EH, BERIA ERFE SMALL LETTER EH
assertEq(String.fromCodePoint(0x16EA4).toLowerCase().codePointAt(0), 0x16EBF); // BERIA ERFE CAPITAL LETTER FITKO, BERIA ERFE SMALL LETTER FITKO
assertEq(String.fromCodePoint(0x16EA5).toLowerCase().codePointAt(0), 0x16EC0); // BERIA ERFE CAPITAL LETTER GOWAY, BERIA ERFE SMALL LETTER GOWAY
assertEq(String.fromCodePoint(0x16EA6).toLowerCase().codePointAt(0), 0x16EC1); // BERIA ERFE CAPITAL LETTER HIRDEABO, BERIA ERFE SMALL LETTER HIRDEABO
assertEq(String.fromCodePoint(0x16EA7).toLowerCase().codePointAt(0), 0x16EC2); // BERIA ERFE CAPITAL LETTER I, BERIA ERFE SMALL LETTER I
assertEq(String.fromCodePoint(0x16EA8).toLowerCase().codePointAt(0), 0x16EC3); // BERIA ERFE CAPITAL LETTER DJAI, BERIA ERFE SMALL LETTER DJAI
assertEq(String.fromCodePoint(0x16EA9).toLowerCase().codePointAt(0), 0x16EC4); // BERIA ERFE CAPITAL LETTER KOBO, BERIA ERFE SMALL LETTER KOBO
assertEq(String.fromCodePoint(0x16EAA).toLowerCase().codePointAt(0), 0x16EC5); // BERIA ERFE CAPITAL LETTER LAKKO, BERIA ERFE SMALL LETTER LAKKO
assertEq(String.fromCodePoint(0x16EAB).toLowerCase().codePointAt(0), 0x16EC6); // BERIA ERFE CAPITAL LETTER MERI, BERIA ERFE SMALL LETTER MERI
assertEq(String.fromCodePoint(0x16EAC).toLowerCase().codePointAt(0), 0x16EC7); // BERIA ERFE CAPITAL LETTER NINI, BERIA ERFE SMALL LETTER NINI
assertEq(String.fromCodePoint(0x16EAD).toLowerCase().codePointAt(0), 0x16EC8); // BERIA ERFE CAPITAL LETTER GNA, BERIA ERFE SMALL LETTER GNA
assertEq(String.fromCodePoint(0x16EAE).toLowerCase().codePointAt(0), 0x16EC9); // BERIA ERFE CAPITAL LETTER NGAY, BERIA ERFE SMALL LETTER NGAY
assertEq(String.fromCodePoint(0x16EAF).toLowerCase().codePointAt(0), 0x16ECA); // BERIA ERFE CAPITAL LETTER OI, BERIA ERFE SMALL LETTER OI
assertEq(String.fromCodePoint(0x16EB0).toLowerCase().codePointAt(0), 0x16ECB); // BERIA ERFE CAPITAL LETTER PI, BERIA ERFE SMALL LETTER PI
assertEq(String.fromCodePoint(0x16EB1).toLowerCase().codePointAt(0), 0x16ECC); // BERIA ERFE CAPITAL LETTER ERIGO, BERIA ERFE SMALL LETTER ERIGO
assertEq(String.fromCodePoint(0x16EB2).toLowerCase().codePointAt(0), 0x16ECD); // BERIA ERFE CAPITAL LETTER ERIGO TAMURA, BERIA ERFE SMALL LETTER ERIGO TAMURA
assertEq(String.fromCodePoint(0x16EB3).toLowerCase().codePointAt(0), 0x16ECE); // BERIA ERFE CAPITAL LETTER SERI, BERIA ERFE SMALL LETTER SERI
assertEq(String.fromCodePoint(0x16EB4).toLowerCase().codePointAt(0), 0x16ECF); // BERIA ERFE CAPITAL LETTER SHEP, BERIA ERFE SMALL LETTER SHEP
assertEq(String.fromCodePoint(0x16EB5).toLowerCase().codePointAt(0), 0x16ED0); // BERIA ERFE CAPITAL LETTER TATASOUE, BERIA ERFE SMALL LETTER TATASOUE
assertEq(String.fromCodePoint(0x16EB6).toLowerCase().codePointAt(0), 0x16ED1); // BERIA ERFE CAPITAL LETTER UI, BERIA ERFE SMALL LETTER UI
assertEq(String.fromCodePoint(0x16EB7).toLowerCase().codePointAt(0), 0x16ED2); // BERIA ERFE CAPITAL LETTER WASSE, BERIA ERFE SMALL LETTER WASSE
assertEq(String.fromCodePoint(0x16EB8).toLowerCase().codePointAt(0), 0x16ED3); // BERIA ERFE CAPITAL LETTER AY, BERIA ERFE SMALL LETTER AY
