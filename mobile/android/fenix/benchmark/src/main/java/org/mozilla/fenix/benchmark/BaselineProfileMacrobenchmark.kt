 ...
 *
 * Please remember to update [arm64-v8a-macrobenchmark.yml](https://searchfox.org/firefox-main/source/mobile/android/test_infra/flank-configs/fenix/arm64-v8a-macrobenchmark.yml)
