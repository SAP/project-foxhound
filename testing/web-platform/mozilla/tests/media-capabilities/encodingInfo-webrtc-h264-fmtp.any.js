...
promise_test(async () => {
  ...
  assert_true(info.supported,
              'libwebrtc maps absence of profile-level-id to CB/3.1 for legacy reasons');
}, 'encodingInfo: H.264 with no profile-level-id is supported');
...
promise_test(async () => {
  ...
  assert_true(info.supported);
}, 'encodingInfo: H.264 with valid profile-level-id 42e01f is supported');
...
}, 'encodingInfo: H.264 with invalid profile-level-id is unsupported');
...
promise_test(async () => {
  ...
  assert_true(info.supported);
}, 'encodingInfo: H.264 packetization-mode=1 is supported');
...
promise_test(async () => {
  ...
  assert_false(info.supported);
}, 'encodingInfo: H.264 packetization-mode=2 is unsupported');
...
promise_test(async () => {
  ...
  assert_false(info.supported);
}, 'encodingInfo: H.264 valid profile-level-id with packetization-mode=2 is unsupported');
...
promise_test(async () => {
  ...
  assert_false(info.supported);
}, 'encodingInfo: H.264 Baseline / level 3.1 with packetization-mode=2 is unsupported');
...
promise_test(async () => {
  ...
  assert_false(info.supported);
}, 'encodingInfo: H.264 CB / level 4.0 with packetization-mode=2 is unsupported');
...
promise_test(async () => {
  ...
  assert_false(info.supported);
}, 'encodingInfo: H.264 Main / level 3.1 with packetization-mode=2 is unsupported');
...
promise_test(async () => {
  ...
  assert_false(info.supported);
}, 'encodingInfo: H.264 High / level 5.2 with packetization-mode=2 is unsupported');
...
promise_test(async () => {
  ...
  assert_false(info.supported);
}, 'encodingInfo: H.264 High 4:4:4 Predictive / level 3.1 is unsupported');
...
promise_test(async () => {
  ...
  assert_false(info.supported);
}, 'encodingInfo: H.264 High 4:4:4 Predictive / level 5.2 is unsupported');
...
promise_test(async () => {
  ...
  assert_false(info.supported);
}, 'encodingInfo: H.264 High 10 / level 3.1 is unsupported');
...
promise_test(async () => {
  ...
  assert_false(info.supported);
}, 'encodingInfo: H.264 High 4:2:2 / level 3.1 is unsupported');
...
promise_test(async () => {
  ...
  assert_false(info.supported);
}, 'encodingInfo: H.264 CB / level 6.0 is unsupported');
...
promise_test(async () => {
  ...
  assert_true(info.supported);
}, 'encodingInfo: H.264 CB / level 1.0 at 128x96 is supported');
