  ...
  'targets' : [
      {
          ...
          'sources' : [
                # Crypto
                "./src/crypto/nr_crypto.cpp",
                "./src/crypto/nr_crypto.h",

                # ICE
                "./src/ice/ice_candidate.cpp",
                "./src/ice/ice_candidate.h",
                "./src/ice/ice_candidate_pair.cpp",
                "./src/ice/ice_candidate_pair.h",
                "./src/ice/ice_codeword.h",
                "./src/ice/ice_component.cpp",
                "./src/ice/ice_component.h",
                "./src/ice/ice_ctx.cpp",
                "./src/ice/ice_ctx.h",
                "./src/ice/ice_handler.h",
                "./src/ice/ice_media_stream.cpp",
                "./src/ice/ice_media_stream.h",
                "./src/ice/ice_parser.cpp",
                "./src/ice/ice_peer_ctx.cpp",
                "./src/ice/ice_peer_ctx.h",
                "./src/ice/ice_reg.h",
                "./src/ice/ice_socket.cpp",
                "./src/ice/ice_socket.h",

                # Net
                "./src/net/nr_resolver.cpp",
                "./src/net/nr_resolver.h",
                "./src/net/nr_socket.cpp",
                "./src/net/nr_socket.h",
                "./src/net/nr_socket_local.h",
                "./src/net/nr_socket_multi_tcp.cpp",
                "./src/net/nr_socket_multi_tcp.h",
                "./src/net/transport_addr.cpp",
                "./src/net/transport_addr.h",
                "./src/net/local_addr.cpp",
                "./src/net/local_addr.h",
                "./src/net/nr_interface_prioritizer.cpp",
                "./src/net/nr_interface_prioritizer.h",

                # STUN
                "./src/stun/addrs.cpp",
                "./src/stun/addrs.h",
                "./src/stun/addrs-bsd.cpp",
                ...
                "./src/stun/nr_socket_buffered_stun.cpp",
                "./src/stun/nr_socket_buffered_stun.h",
                "./src/stun/stun.h",
                "./src/stun/stun_build.cpp",
                "./src/stun/stun_build.h",
                "./src/stun/stun_client_ctx.cpp",
                "./src/stun/stun_client_ctx.h",
                "./src/stun/stun_codec.cpp",
                "./src/stun/stun_codec.h",
                "./src/stun/stun_hint.cpp",
                "./src/stun/stun_hint.h",
                "./src/stun/stun_msg.cpp",
                "./src/stun/stun_msg.h",
                "./src/stun/stun_proc.cpp",
                "./src/stun/stun_proc.h",
                "./src/stun/stun_reg.h",
                "./src/stun/stun_server_ctx.cpp",
                "./src/stun/stun_server_ctx.h",
                "./src/stun/stun_util.cpp",
                "./src/stun/stun_util.h",
                "./src/stun/turn_client_ctx.cpp",
                "./src/stun/turn_client_ctx.h",

                # Util
                "./src/util/ice_util.cpp",
                "./src/util/ice_util.h",
