...
if [ "$1" ] ; then
  ...
  # Upstream doesn't ship config.h (it's generated by their build system).
  # We maintain our own empty placeholder since moz.build defines HAVE_CONFIG_H.
  cp third_party/libsrtp/config.h third_party/libsrtp/src/include/config.h
