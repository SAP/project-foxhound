...
#define __PYX_HAVE__aiohttp___websocket__mask
#define __PYX_HAVE_API__aiohttp___websocket__mask
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from "aiohttp._websocket.mask" */
static void __pyx_f_7aiohttp_10_websocket_4mask__websocket_mask_cython(PyObject *, PyObject *, int __pyx_skip_dispatch); /*proto*/
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "aiohttp._websocket.mask"
extern int __pyx_module_is_main_aiohttp___websocket__mask;
int __pyx_module_is_main_aiohttp___websocket__mask = 0;

/* Implementation of "aiohttp._websocket.mask" */
...
#define __pyx_n_u_aiohttp__websocket_mask __pyx_string_tab[4]
#define __pyx_kp_u_aiohttp__websocket_mask_pyx __pyx_string_tab[5]
...
#define __pyx_n_u_mask __pyx_string_tab[12]
...
/* "aiohttp/_websocket/mask.pyx":11
 * 
 * 
...
static PyObject *__pyx_pw_7aiohttp_10_websocket_4mask_1_websocket_mask_cython(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static void __pyx_f_7aiohttp_10_websocket_4mask__websocket_mask_cython(PyObject *__pyx_v_mask, PyObject *__pyx_v_data, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "aiohttp/_websocket/mask.pyx":22
 *         uint64_t uint64_msk
 * 
 *     assert len(mask) == 4             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  if (unlikely(__pyx_assertions_enabled())) {
    ...
    __pyx_t_1 = __Pyx_PyBytes_GET_SIZE(__pyx_v_mask); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 22, __pyx_L1_error)
  ...
  /* "aiohttp/_websocket/mask.pyx":24
 *     assert len(mask) == 4
 * 
 *     data_len = len(data)             # <<<<<<<<<<<<<<
...
*/
  ...
  __pyx_t_1 = __Pyx_PyByteArray_GET_SIZE(__pyx_v_data); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 24, __pyx_L1_error)
  __pyx_v_data_len = __pyx_t_1;

  /* "aiohttp/_websocket/mask.pyx":25
 * 
 *     data_len = len(data)
 *     in_buf = <unsigned char*>PyByteArray_AsString(data)             # <<<<<<<<<<<<<<
 *     mask_buf = <const unsigned char*>PyBytes_AsString(mask)
...
*/
  __pyx_t_3 = PyByteArray_AsString(__pyx_v_data); if (unlikely(__pyx_t_3 == ((char *)0))) __PYX_ERR(0, 25, __pyx_L1_error)
  __pyx_v_in_buf = ((unsigned char *)__pyx_t_3);

  /* "aiohttp/_websocket/mask.pyx":26
 *     data_len = len(data)
 *     in_buf = <unsigned char*>PyByteArray_AsString(data)
 *     mask_buf = <const unsigned char*>PyBytes_AsString(mask)             # <<<<<<<<<<<<<<
 *     uint32_msk = (<uint32_t*>mask_buf)[0]
 * 
*/
  __pyx_t_3 = PyBytes_AsString(__pyx_v_mask); if (unlikely(__pyx_t_3 == ((char *)0))) __PYX_ERR(0, 26, __pyx_L1_error)
  __pyx_v_mask_buf = ((unsigned char const *)__pyx_t_3);

  /* "aiohttp/_websocket/mask.pyx":27
 *     in_buf = <unsigned char*>PyByteArray_AsString(data)
 *     mask_buf = <const unsigned char*>PyBytes_AsString(mask)
 *     uint32_msk = (<uint32_t*>mask_buf)[0]             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  /* "aiohttp/_websocket/mask.pyx":32
...
*/
  ...
  if (__pyx_t_2) {
    ...
    /* "aiohttp/_websocket/mask.pyx":33
 * 
 *     if sizeof(size_t) >= 8:
 *         uint64_msk = uint32_msk             # <<<<<<<<<<<<<<
 *         uint64_msk = (uint64_msk << 32) | uint32_msk
...
*/
    ...
    /* "aiohttp/_websocket/mask.pyx":34
 *     if sizeof(size_t) >= 8:
 *         uint64_msk = uint32_msk
 *         uint64_msk = (uint64_msk << 32) | uint32_msk             # <<<<<<<<<<<<<<
 * 
...
*/
    ...
    /* "aiohttp/_websocket/mask.pyx":36
 *         uint64_msk = (uint64_msk << 32) | uint32_msk
 * 
 *         while data_len >= 8:             # <<<<<<<<<<<<<<
...
*/
    while (1) {
      __pyx_t_2 = (__pyx_v_data_len >= 8);
      if (!__pyx_t_2) break;

      /* "aiohttp/_websocket/mask.pyx":37
 * 
 *         while data_len >= 8:
 *             (<uint64_t*>in_buf)[0] ^= uint64_msk             # <<<<<<<<<<<<<<
 *             in_buf += 8
...
*/
      ...
      /* "aiohttp/_websocket/mask.pyx":38
 *         while data_len >= 8:
 *             (<uint64_t*>in_buf)[0] ^= uint64_msk
 *             in_buf += 8             # <<<<<<<<<<<<<<
 *             data_len -= 8
...
*/
      ...
      /* "aiohttp/_websocket/mask.pyx":39
 *             (<uint64_t*>in_buf)[0] ^= uint64_msk
 *             in_buf += 8
 *             data_len -= 8             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  /* "aiohttp/_websocket/mask.pyx":42
 * 
 * 
 *     while data_len >= 4:             # <<<<<<<<<<<<<<
...
*/
  while (1) {
    __pyx_t_2 = (__pyx_v_data_len >= 4);
    if (!__pyx_t_2) break;

    /* "aiohttp/_websocket/mask.pyx":43
 * 
 *     while data_len >= 4:
 *         (<uint32_t*>in_buf)[0] ^= uint32_msk             # <<<<<<<<<<<<<<
 *         in_buf += 4
...
*/
    ...
    /* "aiohttp/_websocket/mask.pyx":44
 *     while data_len >= 4:
 *         (<uint32_t*>in_buf)[0] ^= uint32_msk
 *         in_buf += 4             # <<<<<<<<<<<<<<
 *         data_len -= 4
...
*/
    ...
    /* "aiohttp/_websocket/mask.pyx":45
 *         (<uint32_t*>in_buf)[0] ^= uint32_msk
 *         in_buf += 4
 *         data_len -= 4             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  /* "aiohttp/_websocket/mask.pyx":47
 *         data_len -= 4
 * 
 *     for i in range(0, data_len):             # <<<<<<<<<<<<<<
 *         in_buf[i] ^= mask_buf[i]
*/
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    ...
    /* "aiohttp/_websocket/mask.pyx":48
 * 
 *     for i in range(0, data_len):
 *         in_buf[i] ^= mask_buf[i]             # <<<<<<<<<<<<<<
*/
    __pyx_t_9 = __pyx_v_i;
    (__pyx_v_in_buf[__pyx_t_9]) = ((__pyx_v_in_buf[__pyx_t_9]) ^ (__pyx_v_mask_buf[__pyx_v_i]));
  }
...
*/
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_AddTraceback("aiohttp._websocket.mask._websocket_mask_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_L0:;
}
...
PyDoc_STRVAR(__pyx_doc_7aiohttp_10_websocket_4mask__websocket_mask_cython, "Note, this function mutates its `data` argument\n    ");
...
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_mask,&__pyx_mstate_global->__pyx_n_u_data,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "_websocket_mask_cython", 0) < 0) __PYX_ERR(0, 11, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("_websocket_mask_cython", 1, 2, 2, i); __PYX_ERR(0, 11, __pyx_L3_error) }
      }
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_mask), (&PyBytes_Type), 1, "mask", 1))) __PYX_ERR(0, 11, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_data), (&PyByteArray_Type), 1, "data", 1))) __PYX_ERR(0, 11, __pyx_L1_error)
  __pyx_r = __pyx_pf_7aiohttp_10_websocket_4mask__websocket_mask_cython(__pyx_self, __pyx_v_mask, __pyx_v_data);
...
static PyObject *__pyx_pf_7aiohttp_10_websocket_4mask__websocket_mask_cython(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_mask, PyObject *__pyx_v_data) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __Pyx_XDECREF(__pyx_r);
  __pyx_f_7aiohttp_10_websocket_4mask__websocket_mask_cython(__pyx_v_mask, __pyx_v_data, 1); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 11, __pyx_L1_error)
  __pyx_t_1 = __Pyx_void_to_None(NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
...
static int __Pyx_modinit_function_export_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (__Pyx_ExportFunction("_websocket_mask_cython", (void (*)(void))__pyx_f_7aiohttp_10_websocket_4mask__websocket_mask_cython, "void (PyObject *, PyObject *, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "mask" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_mask", 0);
  ...
  }
  {
    ...
    if (!PyDict_GetItemString(modules, "aiohttp._websocket.mask")) {
      if (unlikely((PyDict_SetItemString(modules, "aiohttp._websocket.mask", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 *     """
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_7aiohttp_10_websocket_4mask_1_websocket_mask_cython, 0, __pyx_mstate_global->__pyx_n_u_websocket_mask_cython, NULL, __pyx_mstate_global->__pyx_n_u_aiohttp__websocket_mask, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_websocket_mask_cython, __pyx_t_2) < 0) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "aiohttp/_websocket/mask.pyx":1
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init aiohttp._websocket.mask", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init aiohttp._websocket.mask");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static const __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {__pyx_k_aiohttp__websocket_mask, sizeof(__pyx_k_aiohttp__websocket_mask), 0, 1, 1}, /* PyObject cname: __pyx_n_u_aiohttp__websocket_mask */
  {__pyx_k_aiohttp__websocket_mask_pyx, sizeof(__pyx_k_aiohttp__websocket_mask_pyx), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_aiohttp__websocket_mask_pyx */
...
static int __Pyx_InitCachedBuiltins(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  __pyx_builtin_AssertionError = __Pyx_GetBuiltinName(__pyx_mstate->__pyx_n_u_AssertionError); if (!__pyx_builtin_AssertionError) __PYX_ERR(0, 22, __pyx_L1_error)
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {2, 0, 0, 2, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 11, 180};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_mask, __pyx_mstate->__pyx_n_u_data};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_aiohttp__websocket_mask_pyx, __pyx_mstate->__pyx_n_u_websocket_mask_cython, __pyx_k_3avS_s_1_1_5Qa_Yaq_c_Q_k_D_is_q, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
