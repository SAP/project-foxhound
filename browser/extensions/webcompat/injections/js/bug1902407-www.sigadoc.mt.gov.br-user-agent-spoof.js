...
/**
 * Bug 1902407 - UA spoof for www.sigadoc.mt.gov.br
 *
 * This site is checking for Chrome in navigator.userAgent and window.chrome, so let's spoof those.
 */

if (!window.chrome) {
  console.info(
    "navigator.userAgent and window.chrome are being shimmed for compatibility reasons. https://bugzilla.mozilla.org/show_bug.cgi?id=1902407 for details."
  );
