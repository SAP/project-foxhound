...
async function run_test() {
  ...
  kAutoConfigFile.append("autoconfig_sysconfd.js");
  const kAutoConfigCfg = sysConfD.clone();
  kAutoConfigCfg.append("autoconfig-sysconfd.cfg");
  ...
  try {
    ...
    ok(prefs.prefHasUserValue("_autoconfig_.test.userpref-sysconfd"));
    equal(
      "userpref-sysconfd",
      prefs.getStringPref("_autoconfig_.test.userpref-sysconfd")
    );
