...
#ifndef LAYOUT_STYLE_TYPEDOM_CSSOKLAB_H_
#define LAYOUT_STYLE_TYPEDOM_CSSOKLAB_H_
...
class CSSOKLab final : public CSSColorValue {
 public:
  explicit CSSOKLab(nsCOMPtr<nsISupports> aParent);

  JSObject* WrapObject(JSContext* aCx,
                       JS::Handle<JSObject*> aGivenProto) override;

  // start of CSSOKLab Web IDL declarations

  static already_AddRefed<CSSOKLab> Constructor(const GlobalObject& aGlobal,
  ...
  // end of CSSOKLab Web IDL declarations

 private:
  virtual ~CSSOKLab() = default;
};

}  // namespace dom
}  // namespace mozilla

#endif  // LAYOUT_STYLE_TYPEDOM_CSSOKLAB_H_
