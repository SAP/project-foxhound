...
These values are defined in [TRRSkippedReason.h](https://searchfox.org/firefox-main/source/netwerk/dns/nsITRRSkipReason.idl) and are recorded on _nsHostRecord_ for each resolution.
