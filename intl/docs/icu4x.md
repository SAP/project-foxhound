...
This file documents the procedures for building with [ICU4X](https://github.com/unicode-org/icu4x).
...
4. (Optional) Modify `intl/update-icu4x.sh` to add generated ICU4X data if you want to modify ICU4X baked data.
