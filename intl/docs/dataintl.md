...
:::{note}
Most of the APIs are backed by the Unicode projects [CLDR] and [ICU] and are
...
Data internationalization APIs are formalized in the JavaScript standard [ECMA 402].
...
[Intl.DisplayNames] to additionally provide localization for date-time types.
...
and file a bug in the component [Core::Internationalization] to request it.

[cldr]: http://cldr.unicode.org/
[core::internationalization]: https://bugzilla.mozilla.org/enter_bug.cgi?product=Core&component=Internationalization
