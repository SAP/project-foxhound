...
and conforms to a standard known as [BCP 47] which describes a low level textual
...
[BCP 47] specifies the syntax for each of those fields (called subtags) when
...
Most of the base subtags are valid ISO codes, such as [ISO 639] for
language subtag, or [ISO 3166-1] for region.
...
solution is based on modified logic from [RFC 5656].
...
In the future, Mozilla plans to add a third way for add-ons ([bug 1440969])
...
[bug 1440969]: https://bugzilla.mozilla.org/show_bug.cgi?id=1440969
