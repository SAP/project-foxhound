...
You can try out the [example program](https://mdn.github.io/performance-scenarios/js-call-tree-1/index.html)
and clone the [source code](https://github.com/mdn/performance-scenarios)
