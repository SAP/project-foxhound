...
- [nserror](https://searchfox.org/firefox-main/source/xpcom/rust/nserror/src/lib.rs)
reflects `nsresult` codes into Rust.
- [nsstring](https://searchfox.org/firefox-main/source/xpcom/rust/nsstring/src/lib.rs)
...
- [xpcom](https://searchfox.org/firefox-main/source/xpcom/rust/xpcom/src)
  ...
  - XPCOM component getters are generated by
    [xpcom/components/gen_static_components.py](https://searchfox.org/firefox-main/source/xpcom/components/gen_static_components.py),
  ...
  - A set of `derive` macros help with declaring interface implementations. The
    [docs](https://searchfox.org/firefox-main/source/xpcom/rust/xpcom/xpcom_macros/src/lib.rs)
    have details and examples.
- [moz_task](https://searchfox.org/firefox-main/source/xpcom/rust/moz_task/src/lib.rs)
...
- [storage](https://searchfox.org/firefox-main/source/storage/rust/src/lib.rs)
...
- [storage_variant](https://searchfox.org/firefox-main/source/storage/variant/src/lib.rs)
