...
XPCOM_API(bool)
TAINT_NS_StringTainted(const nsAString& aString)
{
  if (!xpcomFunctions.taintStringTaintedFunc) {
    return false;
  }

  return xpcomFunctions.taintStringTaintedFunc(aString);
}


XPCOM_API(TaintStringRef*)
TAINT_NS_StringTopTaint(nsAString& aString)
{
  if (!xpcomFunctions.taintStringTopTaintFunc) {
    return nullptr;
  }

  return xpcomFunctions.taintStringTopTaintFunc(aString);
}

XPCOM_API(TaintStringRef*)
TAINT_NS_StringBottomTaint(nsAString& aString)
{
  if (!xpcomFunctions.taintStringBottomTaintFunc) {
    return nullptr;
  }

  return xpcomFunctions.taintStringBottomTaintFunc(aString);
}

XPCOM_API(void)
TAINT_NS_StringAddTaintRef(nsAString& aString, TaintStringRef *ref)
{
  if (xpcomFunctions.taintStringAddTaintRefFunc) {
    xpcomFunctions.taintStringAddTaintRefFunc(aString, ref);
  }
}

XPCOM_API(void)
TAINT_NS_StringFfTaint(nsAString& aString)
{
  if (xpcomFunctions.taintStringFfTaintFunc) {
    xpcomFunctions.taintStringFfTaintFunc(aString);
  }
}

XPCOM_API(void)
TAINT_NS_StringRemoveAll(nsAString& aString)
{
  if (xpcomFunctions.taintStringRemoveAllFunc) {
    xpcomFunctions.taintStringRemoveAllFunc(aString);
  }
}
...
{
  if (xpcomFunctions.taintStringRemoveRangeTaintFunc) {
    xpcomFunctions.taintStringRemoveRangeTaintFunc(aString, start, end);
  }
}
...
XPCOM_API(bool)
TAINT_NS_CStringTainted(const nsACString& aString)
{
  if (!xpcomFunctions.taintCStringTaintedFunc) {
    return false;
  }

  return xpcomFunctions.taintCStringTaintedFunc(aString);
}

XPCOM_API(TaintStringRef*)
TAINT_NS_CStringTopTaint(nsACString& aString)
{
  if (!xpcomFunctions.taintCStringTopTaintFunc) {
    return nullptr;
  }

  return xpcomFunctions.taintCStringTopTaintFunc(aString);
}

XPCOM_API(TaintStringRef*)
TAINT_NS_CStringBottomTaint(nsACString& aString)
{
  if (!xpcomFunctions.taintCStringBottomTaintFunc) {
    return nullptr;
  }

  return xpcomFunctions.taintCStringBottomTaintFunc(aString);
}

XPCOM_API(void)
TAINT_NS_CStringAddTaintRef(nsACString& aString, TaintStringRef *ref)
{
  if (xpcomFunctions.taintCStringAddTaintRefFunc) {
    xpcomFunctions.taintCStringAddTaintRefFunc(aString, ref);
  }
}

XPCOM_API(void)
TAINT_NS_CStringFfTaint(nsACString& aString)
{
  if (xpcomFunctions.taintCStringFfTaintFunc) {
    xpcomFunctions.taintCStringFfTaintFunc(aString);
  }
}
...
{
  if (xpcomFunctions.taintCStringRemoveAllFunc) {
    xpcomFunctions.taintCStringRemoveAllFunc(aString);
  }
}
...
{
  if (xpcomFunctions.taintCStringRemoveRangeTaintFunc) {
    xpcomFunctions.taintCStringRemoveRangeTaintFunc(aString, start, end);
  }
}
...
{
  if (!xpcomFunctions.taintDuplicateRangeFunc) {
    return nullptr;
  }

  return xpcomFunctions.taintDuplicateRangeFunc(src, taint_end, frombegin, offset, fromend);
}
