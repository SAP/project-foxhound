...
pref("tainting.source.PushMessageData", false);
pref("tainting.source.PushSubscription.endpoint", false);
pref("tainting.source.WebSocket.MessageEvent.data", false);
pref("tainting.source.XMLHttpRequest.response", false);
pref("tainting.source.document.baseURI", false);
pref("tainting.source.document.cookie", false);
pref("tainting.source.document.documentURI", false);
pref("tainting.source.document.referrer", false);
pref("tainting.source.element.getAttribute", false);
pref("tainting.source.element.getAttributeNS", false);
pref("tainting.source.input.value", false);
pref("tainting.source.localStorage.getItem", false);
pref("tainting.source.location.hash", false);
pref("tainting.source.location.host", false);
pref("tainting.source.location.hostname", false);
pref("tainting.source.location.href", false);
pref("tainting.source.location.origin", false);
pref("tainting.source.location.pathname", false);
pref("tainting.source.location.port", false);
pref("tainting.source.location.protocol", false);
pref("tainting.source.location.search", false);
pref("tainting.source.script.innerHTML", false);
pref("tainting.source.sessionStorage.getItem", false);
pref("tainting.source.window.name", false);
