 ...
 *
 * @param {nsINavHistoryResult} aResult
 *   The result generated by our query.
 * @param {nsINavHistoryQueryOptions.ResultType} aResultType
 *   The required result type.
 * @param {nsINavHistoryQueryOptions.SortByType} aOriginalSortingMode
 ...
 *
 * @param {nsINavHistoryContainerResultNode} aRootNode
 *   The already opened root node from our query's result.
 * @param {nsINavHistoryQueryOptions.SortByType} aExpectedSortingMode
