...
checkBrowsers(paths.appPath, isInteractive)
  ...
  .then(() => {
    var output = file_system.createWriteStream('xpi/taintnotifier.xpi');
    var archive = archiver('zip');

    output.on('close', function () {
      console.log(archive.pointer() + ' total bytes');
      console.log('XPI file has been finalized and the output file descriptor has closed.');
    });
    ...
    archive.directory(paths.appExtension, false);
