...
const doesPanelExist = fs.existsSync(paths.appPanelJs);
const doesPanelHtmlExist = fs.existsSync(paths.panelTemplate);
...
module.exports = function (webpackEnv) {
  ...
  const entryArray = [
    ...
    doesPanelExist && { 'panel': paths.appPanelJs },
  ...
  return {
    ...
    plugins: [
      ...
      doesPanelHtmlExist && plugins.panelHtmlPlugin,
