...
export default [
  ...
  [
    ...
    "  ▶︎  adoptedStyleSheets: Array []",
    "  ├ alinkColor: \"\"",
    "  ▶︎  all: HTMLAllCollection { length: 0 }",
    "  ▶︎  anchors: HTMLCollection { length: 0 }",
    "  ▶︎  applets: HTMLCollection { length: 0 }",
    "  ├ baseURI: \"about:blank\"",
    "  ├ bgColor: \"\"",
    "  ├ body: null",
    "  ├ characterSet: \"UTF-8\"",
    ...
    "  ├ domain: \"example.com\"",
    "  ▶︎  embeds: HTMLCollection { length: 0 }",
    "  ├ fgColor: \"\"",
    "  ├ firstChild: null",
    "  ├ firstElementChild: null",
    "  ▶︎  fonts: FontFaceSet { size: 0, onloading: null, status: \"loaded\", … }",
    "  ▶︎  forms: HTMLCollection { length: 0 }",
    "  ▶︎  fragmentDirective: FragmentDirective {  }",
    "  ├ fullscreen: false",
    "  ├ fullscreenElement: null",
    "  ├ fullscreenEnabled: false",
    "  ├ head: null",
    "  ├ hidden: true",
    "  ▶︎  images: HTMLCollection { length: 0 }",
    "  ▶︎  implementation: DOMImplementation {  }",
    "  ├ inputEncoding: \"UTF-8\"",
    "  ├ isConnected: true",
    "  ├ lastChild: null",
    "  ├ lastElementChild: null",
    ...
    "  ├ linkColor: \"\"",
    "  ▶︎  links: HTMLCollection { length: 0 }",
    "  ├ location: null",
    "  ├ mozFullScreen: false",
    ...
    "  ├ referrer: \"\"",
    "  ├ rootElement: null",
    "  ▶︎  scripts: HTMLCollection { length: 0 }",
    ...
    "  ├ vlinkColor: \"\"",
    "  ▶︎  <get location()>: function location()",
    "  ▶︎  <set location()>: function location()",
    "  ▶︎  <prototype>: DocumentPrototype { getElementsByTagName: getElementsByTagName(), getElementsByTagNameNS: getElementsByTagNameNS(), getElementsByClassName: getElementsByClassName(), … }"
  ],
