...
// PKCS#12 (password "password") with friendlyName "NSS Certificate DB:".
// Generated with: openssl pkcs12 -export -legacy -name 'NSS Certificate DB:'
// -passout pass:password -inkey key.pem -in cert.pem
static const uint8_t friendly_p12[] = {
    ,
    ...
    ,
};

static SECItem* CancelNicknameCallback(SECItem*, PRBool* cancel, void*) {
  *cancel = PR_TRUE;
  return nullptr;
}
...
// sec_pkcs12_sanitize_nickname strips "<TokenName>:" to an empty SECItem.
// Run under ASan.
TEST_F(PK12ImportTest, NssCertDbColonNicknameDoesNotCrash) {
  static const uint8_t password_bmp[] = {0x00, 'p', 0x00, 'a', 0x00, 's',
                                         0x00, 's', 0x00, 'w', 0x00, 'o',
                                         0x00, 'r', 0x00, 'd', 0x00, 0x00};
  SECItem password = {siBuffer, const_cast<uint8_t*>(password_bmp),
                      sizeof(password_bmp)};
  // Internal key slot's token name "NSS Certificate DB" matches the fixture
  // friendlyName prefix.
  ...
  ASSERT_TRUE(dcx);
  SECStatus rv = SEC_PKCS12DecoderUpdate(
      dcx.get(), const_cast<uint8_t*>(friendly_p12), sizeof(friendly_p12));
  ASSERT_EQ(SECSuccess, rv);
  rv = SEC_PKCS12DecoderVerify(dcx.get());
  ASSERT_EQ(SECSuccess, rv);
  // Cancel callback avoids writing to the cert DB.
  SEC_PKCS12DecoderValidateBags(dcx.get(), CancelNicknameCallback);
}
