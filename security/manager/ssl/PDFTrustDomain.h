...
#ifndef PDFTrustDomain_h
#define PDFTrustDomain_h
...
class PDFTrustDomain final : public mozilla::pkix::TrustDomain {
 public:
  typedef mozilla::pkix::Result Result;

  explicit PDFTrustDomain(nsTArray<Span<const uint8_t>>&& collectedCerts);
