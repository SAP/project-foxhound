...
// This is a cut down version of Chromium source file
// base/scoped_native_library.h The chromium sandbox only requires
// ScopedNativeLibrary class to automatically unload the library, which we can
// achieve with UniquePtr.
